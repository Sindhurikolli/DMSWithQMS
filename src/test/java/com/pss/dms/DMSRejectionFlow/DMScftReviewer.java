...
public class DMScftReviewer extends QMSLoginDetails {

	@Test
	public void toDMScftReviewerSOP() throws InterruptedException, IOException, DocumentException, Exception {
//		try {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "DMScftReviewerSOP" + (new Random().nextInt())
				+ ".pdf";
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("DMScftReviewerSOP", "PSS-DMS-022", "Pass");
