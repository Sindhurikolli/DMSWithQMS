...
public class ChangeNoTrainingNotificationListAfterReject extends QMSLoginDetails {

	@Test
	public void toChangeNoTrainingNotificationListAfterReject()
			throws InterruptedException, IOException, DocumentException, Exception {
//		try {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "ChangeNoTrainingNotificationListAfterReject"
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("ChangeNoTrainingNotificationListAfterReject",
				"PSS-DMS-025", "Pass");
...
//        driver.findElement(By.cssSelector("a[href='dmsTrngNotfListPage.do']")).click();
		...
		todoChangeNoTrainingNotificationListAfterReject();
		document.close();
		writer.close();
...
//    }
	...
	private void todoChangeNoTrainingNotificationListAfterReject() throws Exception {
