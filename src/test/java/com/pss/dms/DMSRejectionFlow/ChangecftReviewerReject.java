...
public class ChangecftReviewerReject extends QMSLoginDetails {

	@Test
	public void toChangecftReviewerReject() throws InterruptedException, IOException, DocumentException, Exception {
//		try {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "ChangecftReviewerReject"
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("ChangecftReviewerReject", "PSS-DMS-022", "Pass");
...
//    }
	...
	private void todoChangecftReviewerReject() throws Exception {
		int count = 0;
				...
				if (!applicationWindow.equalsIgnoreCase(pdfWindows)) {
					...
					if (exists) {
						...
						if (webElementList.size() > 0) {
							stagesDownList.selectByIndex(Integer.parseInt("3"));// Initiator
