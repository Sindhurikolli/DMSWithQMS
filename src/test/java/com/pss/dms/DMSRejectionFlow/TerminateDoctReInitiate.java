 ...
 * @author Jeevan
 */
public class TerminateDoctReInitiate extends QMSLoginDetails {

	@Test
	public void toTerminateDoctReInitiate() throws InterruptedException, IOException, DocumentException, Exception {
//		try {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "TerminateDoctReInitiate"
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("TerminateDoctReInitiate", "PSS-DMS-005", "Pass");
		...
		wait1.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector(
				"#rejectedTerminateDocInitiateReqGridId > div > div.jtable-busy-message[style='display: none;']")));
		todoTerminateDoctReInitiate();
		document.close();
		writer.close();
...
//	}
	...
	private void todoTerminateDoctReInitiate() throws Exception {
...
//        if (perPageNoOfRecordsPresent > 0) {//*[@id="rejectedTerminateDocInitiateReqGridId"]/div/div[4]/table/tbody/tr/td[3]
...
//        }
		if (perPageNoOfRecordsPresent > 0 && count == 0) {
			if ((totalNoOfRecords > 1) && ((documentName == null) || ("".equalsIgnoreCase(documentName)))) {
				documentName = driver.findElement(By
						.xpath("//*[@id=\"rejectedTerminateDocInitiateReqGridId\"]/div/div[4]/table/tbody/tr[1]/td[3]"))
				...
				if (totalNoOfRecords > 1) {
					for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
						String newDoctReqNameInApproval = driver.findElement(
								By.xpath("//*[@id=\"rejectedTerminateDocInitiateReqGridId\"]/div/div[4]/table/tbody/tr["
										+ i + "]/td[3]"))
