...
public class ChangeQAReviewerReject extends QMSLoginDetails {

	@Test
	public void toChangeQAReviewerReject() throws InterruptedException, IOException, DocumentException, Exception {
//		try {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "ChangeQAReviewerReject"
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("ChangeQAReviewerReject", "PSS-DMS-021", "Pass");
		writer.setPageEvent(event);
		document.open();
		driver.get(properties.getProperty("DMSURL"));
		Thread.sleep(4000);
		driver.findElement(By.name("loginUserName")).sendKeys(properties.getProperty("DMSQAReviewer"));
...
//    }
	...
	private void todoChangeQAReviewerReject() throws Exception {
		int count = 0;
		...
		Thread.sleep(1000);
		isRecordSelectedForQAReview = selectRecordQAReviewStageSOPRejectFlow(documentDeptSOPReview,
...
//                         		document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click On LogOut ", sno,true);
	...
	private boolean selectRecordQAReviewStageSOPRejectFlow(String documentDeptSOPReview,
