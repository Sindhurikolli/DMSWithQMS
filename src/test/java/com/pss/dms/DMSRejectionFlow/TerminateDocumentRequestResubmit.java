...
public class TerminateDocumentRequestResubmit extends QMSLoginDetails {

	@Test
	public void TerminateDocumentRequestResubmitMethod()
			throws InterruptedException, IOException, DocumentException, Exception {
//		try {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "TerminateDocumentRequestResubmit"
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("TerminateDocumentRequestResubmit", "PSS-DMS-003",
				"Pass");
...
//			WebDriverWait wait = new WebDriverWait(driver, 440);
		...
		Thread.sleep(2000);
		toTerminateDocumentRequestResubmitMethod();
		document.close();
		writer.close();
...
//	}
	...
	private void toTerminateDocumentRequestResubmitMethod() throws Exception {
		Thread.sleep(2000);
