...
public class DMSQAApproverReject extends QMSLoginDetails {

	@Test
	public void toDMSQAApproverReject() throws InterruptedException, IOException, DocumentException, Exception {
//		try {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "DMSQAApproverReject"
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("DMSQAApproverReject", "PSS-DMS-023", "Pass");
...
//    }
	...
	private void todoDMSQAApproverReject() throws Exception {
		int count = 0;
