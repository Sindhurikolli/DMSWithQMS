...
public class TerminateCQAApproverRevert extends QMSLoginDetails {
	@Test
	public void toTerminateCQAApproverRevert() throws InterruptedException, IOException, DocumentException, Exception {
//		try {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "TerminateCQAApproverRevert"
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("TerminateCQAApproverRevert", "PSS-DMS-006", "Pass");
...
//        sno++;
		...
		Thread.sleep(1000);
		todoTerminateCQAApproverRevert();
		document.close();
		writer.close();
...
//    }
	...
	private void todoTerminateCQAApproverRevert() throws Exception {
		sno++;
		int count = 0;
