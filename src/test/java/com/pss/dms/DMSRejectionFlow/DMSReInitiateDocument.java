...
public class DMSReInitiateDocument extends QMSLoginDetails {

	@Test
	public void toDMSReInitiateDocument() throws InterruptedException, IOException, DocumentException, Exception {
//		try {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "DMSReInitiateDocument"
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("DMSReInitiateDocument", "PSS-DMS-019", "Pass");
		...
		Thread.sleep(2000);
		sno++;
		wait1.until(ExpectedConditions.elementToBeClickable(By.id("rejectDmsNewDocIntiateFormAction")));
		...
		wait1.until(ExpectedConditions.presenceOfElementLocated(
				By.cssSelector("#newDocRejectTable > div > div.jtable-busy-message[style='display: none;']")));
...
//    }
	...
	private void methodToDoRejectedDoctInitiateSOPRejectFlow() throws Exception {
		...
		Helper.scrollElement(driver, By.xpath("//*[@id=\"newDocRejectTable\"]/div/div[5]/div[2]/span"));
		...
		if (perPageNoOfRecordsPresent > 0) {
			while (noOfRecordsChecked < totalNoOfRecords) {
				...
				if ((!isRecordSelectedForDeptReview) && (noOfRecordsChecked < totalNoOfRecords)) {
					Helper.clickElement(driver, By.cssSelector("#newDocRejectTable > div > div.jtable-bottom-panel > div.jtable-left-area > span.jtable-page-list > span.jtable-page-number-next"));
//					driver.findElement(By.cssSelector("#newDocRejectTable > div > div.jtable-bottom-panel > div.jtable-left-area > span.jtable-page-list > span.jtable-page-number-next")).click();// next page in Document approve list
					Thread.sleep(3000);
					WebDriverWait wait1 = new WebDriverWait(driver, 60);
					wait1.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("#newDocRejectTable > div > div.jtable-busy-message[style='display: none;']")));
