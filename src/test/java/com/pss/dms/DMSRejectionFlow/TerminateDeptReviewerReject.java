...
public class TerminateDeptReviewerReject extends QMSLoginDetails {
	@Test
	public void toTerminateDeptReviewerReject() throws InterruptedException, IOException, DocumentException, Exception {
//		try {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "TerminateDeptReviewerReject"
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("TerminateDeptReviewerReject", "PSS-DMS-006", "Pass");
...
//        sno++;
		...
		Thread.sleep(1000);
		todoTerminateDeptReviewerReject();
		document.close();
		writer.close();
...
//    }
	...
	private void todoTerminateDeptReviewerReject() throws Exception {
		sno++;
		int count = 0;
