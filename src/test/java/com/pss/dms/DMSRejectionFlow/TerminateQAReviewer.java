...
public class TerminateQAReviewer extends QMSLoginDetails {
	@Test
	public void toTerminateQAReviewer() throws InterruptedException, IOException, DocumentException, Exception {
//		try {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "TerminateQAReviewer"
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("TerminateQAReviewer", "PSS-DMS-006", "Pass");
...
//    }
	...
	private void todoTerminateQAReviewer() throws Exception {
		sno++;
		int count = 0;
