...
public class ChangeQAReviewer extends QMSLoginDetails {

	@Test
	public void toChangeQAReviewer() throws InterruptedException, IOException, DocumentException, Exception {
//		try {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "ChangeQAReviewer" + (new Random().nextInt())
				+ ".pdf";
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("ChangeQAReviewer", "PSS-DMS-007", "Pass");
...
//    }
	...
	private void todoChangeQAReviewer() throws Exception {
		sno++;
		int count = 0;
