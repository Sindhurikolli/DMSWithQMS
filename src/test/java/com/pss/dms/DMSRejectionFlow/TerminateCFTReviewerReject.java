...
public class TerminateCFTReviewerReject extends QMSLoginDetails {
	@Test
	public void toTerminateCFTReviewerReject() throws InterruptedException, IOException, DocumentException, Exception {
//		try {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "TerminateCFTReviewerReject"
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("TerminateCFTReviewerReject", "PSS-DMS-006", "Pass");
