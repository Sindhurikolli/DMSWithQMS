...
public class TerminateQAApproverRevert extends QMSLoginDetails {
	@Test
	public void toTerminateQAApproverRevert() throws InterruptedException, IOException, DocumentException, Exception {
//		try {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "TerminateQAApproverRevert"
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("TerminateQAApproverRevert", "PSS-DMS-006", "Pass");
...
//    }
	...
	private void todoTerminateQAApproverRevert() throws Exception {
		sno++;
		int count = 0;
