...
public class TerminateQAReviewerReject extends QMSLoginDetails {
	@Test
	public void toTerminateQAReviewerReject() throws InterruptedException, IOException, DocumentException, Exception {
//		try {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "TerminateQAReviewerReject"
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("TerminateQAReviewerReject", "PSS-DMS-006", "Pass");
...
//    }
	...
	private void todoTerminateQAReviewerReject() throws Exception {
		sno++;
		int count = 0;
