...
public class DMScftReviewerReject extends QMSLoginDetails {

	@Test
	public void toDMScftReviewerRejectSOP() throws InterruptedException, IOException, DocumentException, Exception {
//		try {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "CFTReviewerReject" + (new Random().nextInt())
				+ ".pdf";
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("CFTReviewerReject", "PSS-DMS-022", "Pass");
