...
public class TerminateCQAApprover extends QMSLoginDetails {
	@Test
	public void toTerminateCQAApprover() throws InterruptedException, IOException, DocumentException, Exception {
//		try {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "TerminateCQAApprover"
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("TerminateCQAApprover", "PSS-DMS-006", "Pass");
...
//    }
	...
	private void todoTerminateCQAApprover() throws Exception {
		sno++;
		int count = 0;
