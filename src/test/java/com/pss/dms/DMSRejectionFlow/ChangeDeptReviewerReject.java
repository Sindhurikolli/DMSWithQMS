...
public class ChangeDeptReviewerReject extends QMSLoginDetails {

	@Test
	public void toChangeDeptReviewerReject() throws InterruptedException, IOException, DocumentException, Exception {
//		try {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "ChangeDeptReviewerReject"
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("ChangeDeptReviewerReject", "PSS-DMS-017", "Pass");
...
//    }
	...
	private void todoChangeDeptReviewerReject() throws Exception {
		int count = 0;
