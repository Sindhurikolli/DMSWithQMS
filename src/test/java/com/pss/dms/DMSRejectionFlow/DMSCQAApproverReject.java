...
public class DMSCQAApproverReject extends QMSLoginDetails {

	@Test
	public void toDMSCQAApproverReject() throws InterruptedException, IOException, DocumentException, Exception {
//		try {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "DMSCQAApproverReject"
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("DMSCQAApproverReject", "PSS-DMS-022", "Pass");
