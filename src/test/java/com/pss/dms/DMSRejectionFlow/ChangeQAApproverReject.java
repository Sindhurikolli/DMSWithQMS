...
public class ChangeQAApproverReject extends QMSLoginDetails {

	@Test
	public void toChangeQAApproverReject() throws InterruptedException, IOException, DocumentException, Exception {
//		try {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "ChangeQAApproverReject"
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("ChangeQAApproverReject", "PSS-DMS-023", "Pass");
...
//    }
	...
	private void todoChangeQAApproverReject() throws Exception {
		int count = 0;
