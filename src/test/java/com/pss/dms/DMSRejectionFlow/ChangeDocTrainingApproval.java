...
public class ChangeDocTrainingApproval extends QMSLoginDetails {

	@Test
	public void toChangeDocTrainingApproval() throws InterruptedException, IOException, DocumentException, Exception {
//		try {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "ChangeDocTrainingApproval"
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("ChangeDocTrainingApproval", "PSS-DMS-011", "Pass");
...
//            Thread.sleep(4000);
		...
		wait1.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[href='dmsDocTrngAppPage.do']")));
		WebElement elem = driver.findElement(By.cssSelector("a[href='dmsDocTrngAppPage.do']"));
		JavascriptExecutor js5 = (JavascriptExecutor) driver;
		js5.executeScript("arguments[0].click();", elem);
...
//    }
	...
	private void todoChangeDocTrainingApproval() throws Exception {
		sno++;
