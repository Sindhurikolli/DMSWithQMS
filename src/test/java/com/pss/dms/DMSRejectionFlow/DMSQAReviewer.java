...
public class DMSQAReviewer extends QMSLoginDetails {

	@Test
	public void toDMSQAReviewerSOP() throws InterruptedException, IOException, DocumentException, Exception {
//		try {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "RejectedDocQAReviewerSOPRejectFlow"
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("RejectedDocQAReviewerSOPRejectFlow", "PSS-DMS-020",
				"Pass");
...
//        document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on Resubmitted rejected radio button", sno,false);
		...
		metodToDoRejectedDocQAReviewerSOPRejectFlow();
		document.close();
		writer.close();
...
//    }
	...
	private void metodToDoRejectedDocQAReviewerSOPRejectFlow() throws Exception {
		int count = 0;
		...
		isRecordSelectedForQAReview = selectRejectedDocQAReviewerSOPRejectFlow(documentDeptSOPReview,
...
//                           		document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click On LogOut ", sno,true);
	...
	private boolean selectRejectedDocQAReviewerSOPRejectFlow(String documentDeptSOPReview,
