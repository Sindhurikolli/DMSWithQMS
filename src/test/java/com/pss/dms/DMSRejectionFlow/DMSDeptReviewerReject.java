...
public class DMSDeptReviewerReject extends QMSLoginDetails {

	@Test
	public void toDMSDeptReviewerRejectSOP() throws InterruptedException, IOException, DocumentException, Exception {
//		try {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "DeptReviewerSOPRejectFlow"
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("toDoDeptReviewerSOPRejectFlow", "PSS-DMS-017", "Pass");
