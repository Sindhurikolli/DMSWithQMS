...
public class DMSDocumentTrainingApprovalReject extends QMSLoginDetails {

	@Test
	public void toDMSDocumentTrainingApprovalReject()
			throws InterruptedException, IOException, DocumentException, Exception {
//		try {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "TrngApprovalRejectSOPRejectFlow"
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("TrngApprovalRejectSOPRejectFlow", "PSS-DMS-024",
				"Pass");
