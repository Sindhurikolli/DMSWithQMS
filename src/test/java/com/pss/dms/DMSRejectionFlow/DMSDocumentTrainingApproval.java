...
public class DMSDocumentTrainingApproval extends QMSLoginDetails {

	@Test
	public void toDMSDocumentTrainingApproval() throws InterruptedException, IOException, DocumentException, Exception {
//		try {
...
//      sno++;
		...
		WebElement element = driver.findElement(By.cssSelector("a[href='dmsDocTrngAppPage.do']"));
