...
public class TerminateDeptReviewer extends QMSLoginDetails {
	@Test
	public void toTerminateDeptReviewer() throws InterruptedException, IOException, DocumentException, Exception {
//		try {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "TerminateDeptReviewer"
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("TerminateDeptReviewer", "PSS-DMS-006", "Pass");
...
//    }
	...
	private void todoTerminateDeptReviewer() throws Exception {
		sno++;
		int count = 0;
