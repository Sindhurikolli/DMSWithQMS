...
public class ChangeDocumentTrainingApprovalReject extends QMSLoginDetails {

	@Test
	public void toChangeDocumentTrainingApprovalReject()
			throws InterruptedException, IOException, DocumentException, Exception {
//		try {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "ChangeDocumentTrainingApprovalReject"
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("ChangeDocumentTrainingApprovalReject", "PSS-DMS-024",
				"Pass");
...
//		    document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on document training sub menu", sno,false);
		...
		WebElement element = driver.findElement(By.id("docTrainingApprovalList"));
		jse.executeScript("arguments[0].click();", element);

//		        Thread.sleep(4000);
//		        driver.findElement(By.xpath("//*[@id=\"dmsDocumentTraining\"]/div/div[1]/strong")).click();
//		        document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on document training sub menu", sno,false);
//		            Thread.sleep(4000);
//		            driver.findElement(By.id("docTrainingApprovalList")).click();
		document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on document training sub menu", sno,
				false);
		Thread.sleep(2000);
		if (driver.findElement(By.id("NotificationTableContainer")).isDisplayed()) {
			System.out.println("Notification Window Displayed");
		...
		todoChangeDocumentTrainingApprovalReject();
		document.close();
		writer.close();
...
//    }
	...
	private void todoChangeDocumentTrainingApprovalReject() throws Exception {
		...
		if (isRecordSelectedTrngApprovalSOP) {
			driver.findElement(By.id("commentsInDocTrainingAppGrid"))
					.sendKeys(properties.getProperty("COMMENTSRevert"));
			document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Enter the comments", sno, false);
			Thread.sleep(1000);
			driver.findElement(By.id("rejectInDocTrngAppGrid")).click();
