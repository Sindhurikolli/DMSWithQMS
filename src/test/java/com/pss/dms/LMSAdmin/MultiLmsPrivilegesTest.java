...
public class MultiLmsPrivilegesTest {
	...
	public void toMultiUserCreation(String LMS_First_Name, String LMS_Last_Name, String AccessLocation)
			throws Throwable {

		Thread.sleep(5000);
		PropertiesConfiguration properties = new PropertiesConfiguration(
				"src\\test\\java\\com\\pss\\dms\\properties\\DMSProperties.properties");
		properties.setProperty("LMS_First_Name", LMS_First_Name);
		properties.setProperty("LMS_Last_Name", LMS_Last_Name);
		properties.setProperty("AccessLocation", AccessLocation);
		properties.save();

		Thread.sleep(5000);
		QMSLoginDetails login = new QMSLoginDetails();
		login.setUp();
		LmsPrivileges Access = new LmsPrivileges();
		Access.toDoLmsPrivileges();
	...
	public static Object[][] readExcelFile() throws InvalidFormatException, IOException {
		...
		XSSFSheet sh = wb.getSheet("LmsPrivilages");
