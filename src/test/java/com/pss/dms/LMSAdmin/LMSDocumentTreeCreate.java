 ...
 * @author Jeevan
 */
public class LMSDocumentTreeCreate extends QMSLoginDetails {
	...
	public void toDoDocumentTreeCreation() throws Exception {
		...
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "LMSDocumentTreeCreate"
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("LMSDocumentTreeCreate", "PSS-DMS-012", "Pass");
		...
		wait1.until(ExpectedConditions.elementToBeClickable(By.id("defaultSettingsInCal")));
		sno++;
		driver.findElement(By.id("defaultSettingsInCal")).click();
	...
	private void methodToDoDocumentTreeCreationInLms() throws Exception {
