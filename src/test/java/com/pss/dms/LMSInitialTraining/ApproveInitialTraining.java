...
public class ApproveInitialTraining extends QMSLoginDetails {

	@Test
	public void plannedScheduleApprove() throws Exception {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "ApproveInitialTraining"
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("Initial Training Approval", "PSS-LMS-006", "Pass");
...
//		WebElement element1 = driver.findElement(By.id("schedulePlanApprovalList"));
