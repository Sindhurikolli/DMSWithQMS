...
public class MultiDmsPrivilegesTest {
	...
	public void toMultiUserCreation(String E_codeforPrivilages, String AccessLocation) throws Throwable {

		Thread.sleep(5000);
		PropertiesConfiguration properties = new PropertiesConfiguration(
				"src\\test\\java\\com\\pss\\dms\\properties\\DMSProperties.properties");
		properties.setProperty("E_codeforPrivilages", E_codeforPrivilages);
		...
		login.setUp();
		DmsPrivileges Access = new DmsPrivileges();
		Access.toDoDmsPrivileges();
	...
	public static Object[][] readExcelFile() throws InvalidFormatException, IOException {
		...
		XSSFSheet sh = wb.getSheet("Privillages");
