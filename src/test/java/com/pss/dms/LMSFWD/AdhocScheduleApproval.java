...
//		jse1.executeScript("arguments[0].scrollIntoView(true);", element1);
		...
		wait1.until(ExpectedConditions.presenceOfElementLocated(By.id("schedulePlanApprovalList")));
		...
		wait1.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("#schedulePlanApprovalTable > div > div.jtable-busy-message[style='display: none;']")));
