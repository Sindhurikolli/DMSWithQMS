...
public class CreateTopicQuestions extends QMSLoginDetails {
	...
	public void toCeateTopicQuestions() throws Exception {
		...
		wait.until(
				ExpectedConditions.presenceOfAllElementsLocatedBy(By.id("createQuestionBank")));
		document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on Assign Topic Questions", sno,
				false);
		sno++;
...
//		driver.findElement(By.id("itemName")).click();
		...
		document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Enter Topic Name", sno, false);
		sno++;
		Thread.sleep(3000);		
