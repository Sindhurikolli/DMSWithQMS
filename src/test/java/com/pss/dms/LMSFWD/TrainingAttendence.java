...
//		jse1.executeScript("arguments[0].scrollIntoView(true);", element1);
		...
		wait1.until(ExpectedConditions.elementToBeClickable(By.id("trainingAttendance")));
		...
		wait1.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("#trainingAttendaceJtable > div > div.jtable-busy-message[style='display: none;']")));
