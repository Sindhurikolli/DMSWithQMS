...
//		jse1.executeScript("arguments[0].scrollIntoView(true);", element1);
		...
		wait1.until(ExpectedConditions.elementToBeClickable(By.id("questionPaperList")));

		document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on Question Paper", sno, false);
		driver.findElement(By.id("questionPaperList")).click();
		
		Thread.sleep(4000);
		wait1.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("#questionPaperJtable > div > div.jtable-busy-message[style='display: none;']")));
