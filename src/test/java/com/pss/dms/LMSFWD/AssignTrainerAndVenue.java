...
//		WebElement element1 = driver.findElement(By.id("assignTrainerAndVenue"));
//		jse1.executeScript("arguments[0].scrollIntoView(true);", element1);
		Thread.sleep(2000);
		WebDriverWait wait = new WebDriverWait(driver, 90);
		wait.until(ExpectedConditions.elementToBeClickable(By.id("assignTrainerAndVenue")));
...
//			Thread.sleep(3000);
			...
			Thread.sleep(4000);
			sno++;
			driver.findElement(By.cssSelector("body > div:nth-child(74) > div.ui-dialog-buttonpane.ui-widget-content.ui-helper-clearfix > div > button:nth-child(1) > span")).click();
