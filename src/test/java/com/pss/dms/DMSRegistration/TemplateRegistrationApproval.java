...
public class TemplateRegistrationApproval extends QMSLoginDetails {

	@Test
	public void TemplateRegistrationApprovalMethod()
			throws InterruptedException, IOException, DocumentException, Exception {
//		try {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "TemplateRegistrationApproval"
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("TemplateRegistrationApproval", "PSS-DMS-004", "Pass");
		...
		wait1.until(ExpectedConditions.elementToBeClickable(By.cssSelector("a[href='dmsTemplateApproval.do']")));
		driver.findElement(By.cssSelector("a[href='dmsTemplateApproval.do']")).click();
		...
		wait1.until(ExpectedConditions.presenceOfElementLocated(
				By.cssSelector("#dmsTemplateAppTable > div > div.jtable-busy-message[style='display: none;']")));
		toTemplateRegistrationApprovalMethod();
		document.close();
		writer.close();
...
//	}
	...
	private void toTemplateRegistrationApprovalMethod() throws Exception {
		Thread.sleep(1000);
		sno++;
		boolean isRecordSelectedForApprovalReq = false;
		int count = 0;
		String Product_Name = properties.getProperty("Template_Name");
	...
	private boolean selectRecordDocReqApproval(String Product_Name, boolean isRecordSelectedForApprovalReq, int count)
		...
		if (perPageNoOfRecordsPresent > 0) {
			String a = driver.findElement(By.xpath("//*[@id=\"dmsTemplateAppTable\"]/div/div[4]/div[2]/span"))
		...
		if (perPageNoOfRecordsPresent > 0 && count == 0) {
			if ((totalNoOfRecords > 1) && ((Product_Name == null) || ("".equalsIgnoreCase(Product_Name)))) {
				...
				Product_Name = driver.findElement(By.xpath("//*[@id=\"dmsTemplateAppTable\"]/div/table/tbody/tr/td[3]"))
						.getText();// documentType
			}
			++count;
		}
