...
public class MultiUsersAssignRoleLMSTest {

	static File resultFile = new File("DMSWithQMS User Details for Automation.xlsx");
	public static DataFormatter formatter = new DataFormatter();

	@Test(dataProvider = "readExcelFile")
	public void toMultiUserCreation(String LMSUserFirstName, String LMSUserLastName, String LMSRoleName)
			throws Throwable {

		Thread.sleep(5000);
		PropertiesConfiguration properties = new PropertiesConfiguration(
				"src\\test\\java\\com\\pss\\dms\\properties\\DMSProperties.properties");
		properties.setProperty("LMSUserFirstName", LMSUserFirstName);
		properties.setProperty("LMSUserLastName", LMSUserLastName);
		properties.setProperty("LMSRoleName", LMSRoleName);
		properties.save();

		Thread.sleep(5000);
		QMSLoginDetails login = new QMSLoginDetails();
		login.setUp();
		System.out.println("Role Assigned for - " + LMSUserFirstName + LMSUserLastName);
		LMSAssignRole role = new LMSAssignRole();
		role.LMSAssignRoleMethod();
	...
	public static Object[][] readExcelFile() throws InvalidFormatException, IOException {
		...
		XSSFSheet sh = wb.getSheet("LMSRole");
