...
public class MultiUsersAssignRoleChangeControlTest {

	static File resultFile = new File("DMSWithQMS User Details for Automation.xlsx");
	public static DataFormatter formatter = new DataFormatter();

	@Test(dataProvider = "readExcelFile")
	public void toMultiUserCreation(String ChangeControlUserE_Code, String ChangeControlRoleName) throws Throwable {

		Thread.sleep(5000);
		PropertiesConfiguration properties = new PropertiesConfiguration(
				"src\\test\\java\\com\\pss\\dms\\properties\\DMSProperties.properties");
		properties.setProperty("ChangeControlUserE_Code", ChangeControlUserE_Code);
		properties.setProperty("ChangeControlRoleName", ChangeControlRoleName);
		properties.save();

		Thread.sleep(5000);
		QMSLoginDetails login = new QMSLoginDetails();
		login.setUp();
		System.out.println("Role Assigned for - " + ChangeControlUserE_Code);
		ChangeControlAssignRole role = new ChangeControlAssignRole();
		role.ChangeControlAssignRoleMethod();
	...
	public static Object[][] readExcelFile() throws InvalidFormatException, IOException {
		...
		XSSFSheet sh = wb.getSheet("CCRole");
