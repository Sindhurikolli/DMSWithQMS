...
public class MultiUsersAssignRoleDMSTest {

	static File resultFile = new File("DMSWithQMS User Details for Automation.xlsx");
	public static DataFormatter formatter = new DataFormatter();

	@Test(dataProvider = "readExcelFile")
	public void toMultiUserCreation(String DMSUserE_Code, String DMSRoleName) throws Throwable {

		Thread.sleep(5000);
		PropertiesConfiguration properties = new PropertiesConfiguration(
				"src\\test\\java\\com\\pss\\dms\\properties\\DMSProperties.properties");
		properties.setProperty("DMSUserE_Code", DMSUserE_Code);
		properties.setProperty("DMSRoleName", DMSRoleName);
		properties.save();

		Thread.sleep(5000);
		QMSLoginDetails login = new QMSLoginDetails();
		login.setUp();
		System.out.println("Role Assigned for - " + DMSUserE_Code);
		DMSAssignRole role = new DMSAssignRole();
		role.DMSAssignRoleMethod();
	...
	public static Object[][] readExcelFile() throws InvalidFormatException, IOException {
		...
		XSSFSheet sh = wb.getSheet("DMSRole");
