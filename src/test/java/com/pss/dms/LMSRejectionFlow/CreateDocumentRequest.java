...
public class CreateDocumentRequest extends QMSLoginDetails {

	@Test
	public void toCreateDocumentRequest() throws InterruptedException, IOException, DocumentException, Exception {
//		try {
...
//	}
	...
	private void todoCreateDocumentRequest() throws Exception {
		Thread.sleep(2000);
		JavascriptExecutor jse = (JavascriptExecutor) driver;
		WebElement element = driver.findElement(By.xpath("//*[@id=\"maskingId\"]/div[3]/ul/li[2]/a"));
		jse.executeScript("arguments[0].scrollIntoView(true);", element);
