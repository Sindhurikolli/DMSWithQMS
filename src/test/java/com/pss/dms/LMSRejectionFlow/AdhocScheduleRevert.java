...
public class AdhocScheduleRevert extends QMSLoginDetails {

	@Test
	public void toAdhocScheduleRevert() throws Exception {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "AdhocScheduleRevert"
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("Schedule Plan Revert", "PSS-LMS-002", "Pass");
...
//		jse1.executeScript("arguments[0].scrollIntoView(true);", element1);
	...
	private void todoAdhocScheduleRevert() throws Exception {
		...
		if (isRecordSelected) {
			...
			Thread.sleep(2000);
			sno++;
			driver.findElement(By.xpath("//*[@id=\"dialogForSchedulePlanApprovalTable\"]/div[12]/div/div/button[2]"))
					.click();
