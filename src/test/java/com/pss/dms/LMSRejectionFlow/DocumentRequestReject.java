...
public class DocumentRequestReject extends QMSLoginDetails {

	@Test
	public void toDocumentRequestReject() throws InterruptedException, IOException, DocumentException, Exception {
//		try {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "DocumentRequestReject"
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("DocumentRequestReject", "PSS-DMS-004", "Pass");
...
//	}
	...
	private void todoDocumentRequestReject() throws Exception {
		Thread.sleep(1000);
		sno++;
		...
		if (isRecordSelectedForApprovalReq) {
			driver.findElement(By.id("newDocRequestAppComments")).sendKeys(properties.getProperty("COMMENTSRevert"));
			document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Enter the comments", sno, false);
			Thread.sleep(1000);
			sno++;
			driver.findElement(By.id("rejectBtnInnewDocRequestApp")).click();
