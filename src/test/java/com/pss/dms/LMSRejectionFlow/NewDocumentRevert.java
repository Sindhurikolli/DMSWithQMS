...
public class NewDocumentRevert extends QMSLoginDetails {

	@Test
	public void toNewDocumentRevert() throws InterruptedException, IOException, DocumentException, Exception {
//		try {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "NewDocumentRevert" + (new Random().nextInt())
				+ ".pdf";
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("NewDocumentRevert", "PSS-DMS-004", "Pass");
...
//	}
	...
	private void methodToDoDocmtApprovalRequestSOP() throws Exception {
		...
		if (isRecordSelectedForApprovalReq) {
			driver.findElement(By.id("commentsInLmsDocApprWin")).sendKeys(properties.getProperty("COMMENTSRevert"));
			document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Enter the comments", sno, false);
			Thread.sleep(1000);
			sno++;
			driver.findElement(By.id("rejBtnIdInLmsDocAppr")).click();
