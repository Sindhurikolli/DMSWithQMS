 ...
 * @author Jeevan
 */
public class DoctViewSOPRejectFlow extends QMSLoginDetails {

	public DoctViewSOPRejectFlow() {
	}
	...
	@Test
	public void toDoDoctViewSOPRejectFlow() throws InterruptedException {
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		methodToDoSearchViewSOPDoctRejectFlow();
	}

	private void methodToDoSearchViewSOPDoctRejectFlow() throws InterruptedException {
		...
		Thread.sleep(1000);
		isRecordSelected = selectDoctRecdViewSOPDoctRejectFlow(doctNameView, isRecordSelected, count);
		Thread.sleep(2000);
		if (isRecordSelected) {
	...
	private boolean selectDoctRecdViewSOPDoctRejectFlow(String doctNameView, boolean isRecordSelected, int count)
