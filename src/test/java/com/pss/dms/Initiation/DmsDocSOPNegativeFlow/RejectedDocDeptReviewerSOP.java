 ...
 * @author Jeevan
 */
public class RejectedDocDeptReviewerSOP extends QMSLoginDetails {

	public RejectedDocDeptReviewerSOP() {
	}
	...
	@Test
	public void toDoRejectedDocDeptReviewerSOP()
		...
		try {
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("RejectedDocDeptReviewerSOP", "PSS-DMS-020",
					"Pass");
