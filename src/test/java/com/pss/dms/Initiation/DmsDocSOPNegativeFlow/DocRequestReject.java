...
public class DocRequestReject extends QMSLoginDetails {

	@Test
	public void toDoDocRequestReject() throws InterruptedException, IOException, DocumentException, Exception {
		try {

			document = new Document();
			Font font = new Font(Font.FontFamily.TIMES_ROMAN);
			output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "DocRequestReject"
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("DocRequestReject", "PSS-DMS-015", "Pass");
