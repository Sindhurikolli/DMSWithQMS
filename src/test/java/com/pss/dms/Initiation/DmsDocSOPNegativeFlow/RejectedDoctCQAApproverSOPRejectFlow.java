 ...
 * @author Jeevan
 */
public class RejectedDoctCQAApproverSOPRejectFlow extends QMSLoginDetails {

	public RejectedDoctCQAApproverSOPRejectFlow() {
	}
	...
	@Test
	public void toDoRejectedDoctCQAApproverSOPRejectFlow() throws InterruptedException {
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		methodToDoRejectedDoctCQAApproverSOPRejectFlow();
	}

	private void methodToDoRejectedDoctCQAApproverSOPRejectFlow() throws InterruptedException {
		int count = 0;
		...
		isRecordSelectedForCQAApprover = selectRecordForCQAApproverSOPRejectedFlow(documentDeptSOPReview,
	...
	private boolean selectRecordForCQAApproverSOPRejectedFlow(String documentDeptSOPReview,
