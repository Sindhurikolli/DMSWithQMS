 ...
 * @author Jeevan
 */
public class RejectedDocCFTReviewSOPRejectflow extends QMSLoginDetails {

	public RejectedDocCFTReviewSOPRejectflow() {
	}
	...
	@Test
	public void toDoRejectedDocCFTReviewSOPRejectflow()
			throws InterruptedException, IOException, DocumentException, Exception {
		try {

			document = new Document();
			Font font = new Font(Font.FontFamily.TIMES_ROMAN);
			output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "RejectedDocCFTReviewSOPRejectflow"
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("RejectedDocCFTReviewSOPRejectflow", "PSS-DMS-022",
					"Pass");
...
//        document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on Resubmitted rejected radio button", sno,false);
			Thread.sleep(10000);
			methodToDoRejectedDocCFTReviewSOPRejectflow();
			document.close();
			writer.close();
	...
	private void methodToDoRejectedDocCFTReviewSOPRejectflow() throws Exception {
		int count = 0;
		...
		isRecordSelectedForCFTReview = selectRecordRejectedDocCFTReviewSOPRejectflow(documentDeptSOPReview,
	...
	private boolean selectRecordRejectedDocCFTReviewSOPRejectflow(String documentDeptSOPReview,
