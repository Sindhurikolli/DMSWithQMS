 ...
 * @author Jeevan
 */
public class DeptReviewerSOPRejectFlow extends QMSLoginDetails {

	public DeptReviewerSOPRejectFlow() {
	}
	...
	public void toDoDeptReviewerSOPRejectFlow() throws InterruptedException, IOException, DocumentException, Exception {
		try {
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("toDoDeptReviewerSOPRejectFlow", "PSS-DMS-017",
					"Pass");
