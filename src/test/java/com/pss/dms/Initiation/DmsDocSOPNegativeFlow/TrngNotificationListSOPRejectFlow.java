 ...
 * @author Jeevan
 */
public class TrngNotificationListSOPRejectFlow extends QMSLoginDetails {

	public TrngNotificationListSOPRejectFlow() {
	}
	...
	@Test
	public void toDoTrngNotificationListSOPRejectFlow()
		...
		try {
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("TrainingNotificationListSOP", "PSS-DMS-023",
					"Pass");
