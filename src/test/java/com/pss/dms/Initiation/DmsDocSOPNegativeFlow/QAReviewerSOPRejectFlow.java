 ...
 * @author Jeevan
 */
public class QAReviewerSOPRejectFlow extends QMSLoginDetails {

	public QAReviewerSOPRejectFlow() {
	}
	...
	@Test
	public void toDoQAReviewerSOPRejectFlow() throws InterruptedException, IOException, DocumentException, Exception {
		try {
			...
			Thread.sleep(10000);
			Thread.sleep(10000);
			metodToDoQAReviewerSOPRejectFlow();
			document.close();
			writer.close();
	...
	private void metodToDoQAReviewerSOPRejectFlow() throws Exception {
		int count = 0;
