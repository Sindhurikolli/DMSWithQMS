 ...
 * @author Jeevan
 */
public class RejectedDoctTrainingApprovalSOPRejectedFlow extends QMSLoginDetails {

	public RejectedDoctTrainingApprovalSOPRejectedFlow() {
	}
	...
	public void toDoRejectedDoctTrainingApprovalSOPRejectedFlow()
		...
		try {
			...
			output = System.getProperty("user.dir") + "\\" + "/TestReport/"
					+ "RejectedDoctTrainingApprovalSOPRejectedFlow" + (new Random().nextInt()) + ".pdf";
			...
			if (totalNoOfRecords > 1) {
				for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
					String newDoctReqNameInApproval = driver.findElement(By.xpath(
							"//*[@id=\"docTrainingRejectedGridStore\"]/div/div[4]/table/tbody/tr[ " + i + " ]/td[2]"))
