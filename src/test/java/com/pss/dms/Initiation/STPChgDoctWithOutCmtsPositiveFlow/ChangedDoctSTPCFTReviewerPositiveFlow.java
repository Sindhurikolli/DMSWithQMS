 ...
 * @author Jeevan
 */
public class ChangedDoctSTPCFTReviewerPositiveFlow extends QMSLoginDetails {

	public ChangedDoctSTPCFTReviewerPositiveFlow() {
	}
	...
	@Test
	public void toDoChangedDoctSTPCFTReviewerPositiveFlow() throws InterruptedException {
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		metodToDoCFTReviewerApprovalChgSTPDoctApprovalFlow();
		Thread.sleep(1000);
	...
	private void metodToDoCFTReviewerApprovalChgSTPDoctApprovalFlow() throws InterruptedException {
		int count = 0;
		String documentCFTSOPReview = properties.getProperty("DOCUMENT_NAME_STP_DOCT_REQUEST_CHG_DOCT_APPROVAL_FLOW");
		boolean isRecordSelectedForCFTReview = false;
		isRecordSelectedForCFTReview = selectRecordCFTReviewApprovalSTPChgApprovalFlow(documentCFTSOPReview,
	...
	private boolean selectRecordCFTReviewApprovalSTPChgApprovalFlow(String documentCFTSOPReview,
