 ...
 * @author Jeevan
 */
public class ChangedDoctSTPDeptReviewPositiveFlow extends QMSLoginDetails {

	public ChangedDoctSTPDeptReviewPositiveFlow() {
	}
	...
	@Test
	public void toDoChangedDoctSTPDeptReviewPositiveFlow() throws InterruptedException {
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		methodToSelectRecordSTPDoctDeptReviewApprovalFlow();
		Thread.sleep(1000);
		driver.manage().deleteAllCookies();
		Thread.sleep(1000);
	}

	private void methodToSelectRecordSTPDoctDeptReviewApprovalFlow() throws InterruptedException {
		int count = 0;
		...
		isRecordSelectedForDeptReview = selectChgDoctSTPApprovalFlowRecord(documentDeptSTPReview,
	...
	private boolean selectChgDoctSTPApprovalFlowRecord(String documentDeptSOPReview,
