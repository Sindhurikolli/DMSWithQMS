 ...
 * @author Jeevan
 */
public class QAReviewerSTPWithChgDoctPositiveFlow extends QMSLoginDetails {

	public QAReviewerSTPWithChgDoctPositiveFlow() {
	}
	...
	@Test
	public void toDoQAReviewerSTPWithChgDoctPositiveFlow() throws InterruptedException {
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		methodToDoQAReviewerSTPInitiateDocsPositiveFlow();

	}

	private void methodToDoQAReviewerSTPInitiateDocsPositiveFlow() throws InterruptedException {
		int count = 0;
		String documentQASTPReview = properties.getProperty("DOCUMENT_NAME_STP_DOCT_REQUEST_CHG_DOCT_APPROVAL_FLOW");
		boolean isRecordSelectedForQAReview = false;
		isRecordSelectedForQAReview = selectRecordQAReviewStageSTPDoctWithChgDoctPositiveFlow(documentQASTPReview,
	...
	private boolean selectRecordQAReviewStageSTPDoctWithChgDoctPositiveFlow(String documentQASTPReview,
