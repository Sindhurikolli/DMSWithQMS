 ...
 * @author Jeevan
 */
public class TrngCompletedSTPChgDoctPositiveFlow extends QMSLoginDetails {

	public TrngCompletedSTPChgDoctPositiveFlow() {
	}
	...
	@Test
	public void toDoTrngCompletedSTPChgDoctPositiveFlow() throws InterruptedException {
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		methodToSelectRecordTrngCompletedListSTPChgDoctPositiveFlow();

	}

	private void methodToSelectRecordTrngCompletedListSTPChgDoctPositiveFlow() throws InterruptedException {
		...
		isRecordSelectedTrngCompletedList = selectRecordTrngCompletedSTPChgDoctPositiveFlow(documentNameTrngCompleted,
	...
	private boolean selectRecordTrngCompletedSTPChgDoctPositiveFlow(String documentNameTrngCompleted,
