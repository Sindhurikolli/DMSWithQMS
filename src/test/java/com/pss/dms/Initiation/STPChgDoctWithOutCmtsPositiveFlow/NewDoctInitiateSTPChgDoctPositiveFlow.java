 ...
 * @author Jeevan
 */
public class NewDoctInitiateSTPChgDoctPositiveFlow extends QMSLoginDetails {

	public NewDoctInitiateSTPChgDoctPositiveFlow() {
	}
	...
	@Test
	public void toDoNewDoctInitiateSTPChgDoctPositiveFlow() throws InterruptedException {
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		methodToSelectRecdNewDocumentInitiateSTPChgDoctPositiveFlow();

	}

	private void methodToSelectRecdNewDocumentInitiateSTPChgDoctPositiveFlow() throws InterruptedException {
		int count = 0;
		String documentNameSTPInitiate = properties
		...
		if (isRecordSelectedDocumentInitiate) {
			...
			driver.findElement(By.id("documentNoOfDocumentUpload"))
					.sendKeys(properties.getProperty("DOCT_NO_INITIATE_NEW_DOCT_STP_CHG_APPROVAL_FLOW"));
			Thread.sleep(1000);
			...
			driver.findElement(By.linkText("Next")).click();
			Thread.sleep(2000);
			methodToAddFormatDoctInitiateSTPWithChgPositiveFlow();
		} else {
			System.out.println("Record is not Selected");
		}
	}

	private void methodToAddFormatDoctInitiateSTPWithChgPositiveFlow() throws InterruptedException {
		...
		driver.findElement(By.id("createFormatName1"))
				.sendKeys(properties.getProperty("DOCT_NAME_FORMAT_STP_CHG_APPROVAL_FLOW"));
		Thread.sleep(1000);
		driver.findElement(By.linkText("Next")).click();
		Thread.sleep(2000);
