 ...
 * @author Jeevan
 */
public class TrngApprovalWithChgDoctSTPPositiveFlow extends QMSLoginDetails {

	public TrngApprovalWithChgDoctSTPPositiveFlow() {
	}
	...
	@Test
	public void toDoTrngApprovalWithChgDoctSTPPositiveFlow() throws InterruptedException {
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		methodToSelectRecordToDoTrngApprovalSTPPositiveFlow();
	}

	private void methodToSelectRecordToDoTrngApprovalSTPPositiveFlow() throws InterruptedException {
		boolean isRecordSelectedTrngApprovalSOP = false;
		int count = 0;
		String doctNameTrngApprovalSOP = properties
				.getProperty("DOCUMENT_NAME_STP_DOCT_REQUEST_CHG_DOCT_APPROVAL_FLOW");
		isRecordSelectedTrngApprovalSOP = selectRecordToDOTrngApprovalSTPPositiveFlw(doctNameTrngApprovalSOP,
	...
	private boolean selectRecordToDOTrngApprovalSTPPositiveFlw(String doctNameTrngApprovalSOP,
