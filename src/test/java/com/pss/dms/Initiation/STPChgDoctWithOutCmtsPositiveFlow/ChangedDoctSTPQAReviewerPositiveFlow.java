 ...
 * @author Jeevan
 */
public class ChangedDoctSTPQAReviewerPositiveFlow extends QMSLoginDetails {

	public ChangedDoctSTPQAReviewerPositiveFlow() {
	}
	...
	@Test
	public void toDoChangedDoctSTPQAReviewerPositiveFlow() throws InterruptedException {
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		methodToSelectRecordQAReviewApprovalFlowSTP();
		Thread.sleep(1000);
	...
	private void methodToSelectRecordQAReviewApprovalFlowSTP() throws InterruptedException {
		int count = 0;
		...
		isRecordSelectedForQAReview = selectRecQAReviewApprovalSTPChgApprovalFlow(documentDeptSOPReview,
	...
	private boolean selectRecQAReviewApprovalSTPChgApprovalFlow(String documentDeptSOPReview,
