 ...
 * @author Jeevan
 */
public class DeptReviewerSTPWithChgDoctPositiveFlow extends QMSLoginDetails {

	public DeptReviewerSTPWithChgDoctPositiveFlow() {
	}
	...
	@Test
	public void toDoDeptReviewerSTPWithChgDoctPositiveFlow() throws InterruptedException {
		Thread.sleep(1000);
		...
		methodToDoDeptReviewerSTPWithChgDoctPositiveFlow();

	}

	private void methodToDoDeptReviewerSTPWithChgDoctPositiveFlow() throws InterruptedException {
		int count = 0;
		String documentDeptSTPReview = properties.getProperty("DOCUMENT_NAME_STP_DOCT_REQUEST_CHG_DOCT_APPROVAL_FLOW");
		boolean isRecordSelectedForDeptReview = false;
		isRecordSelectedForDeptReview = selectRecordDeptReviewStageDeptSTPPositiveFlwChgDoct(documentDeptSTPReview,
	...
	private boolean selectRecordDeptReviewStageDeptSTPPositiveFlwChgDoct(String documentDeptSTPReview,
