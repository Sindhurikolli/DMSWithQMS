 ...
 * @author Jeevan
 */
public class CFTReviewerSTPDoctPositiveFlow extends QMSLoginDetails {

	public CFTReviewerSTPDoctPositiveFlow() {
	}
	...
	//
	@Test
	public void toDoCFTReviewerSTPDoctPositiveFlow() throws InterruptedException {
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		metodToDoCFTReviewerSTPDoctDmsPositiveFlowWithChgDoct();
	}

	private void metodToDoCFTReviewerSTPDoctDmsPositiveFlowWithChgDoct() throws InterruptedException {
		int count = 0;
		String documentDeptSOPReview = properties.getProperty("DOCUMENT_NAME_STP_DOCT_REQUEST_CHG_DOCT_APPROVAL_FLOW");
		boolean isRecordSelectedForCFTReview = false;
		isRecordSelectedForCFTReview = selectRecordCFTReviewStageSTPWithChangeDoctPositiveFlw(documentDeptSOPReview,
	...
	private boolean selectRecordCFTReviewStageSTPWithChangeDoctPositiveFlw(String documentDeptSOPReview,
