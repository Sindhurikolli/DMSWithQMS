 ...
 * @author Jeevan
 */
public class DocumentViewSTPPositiveFlow extends QMSLoginDetails {

	public DocumentViewSTPPositiveFlow() {
	}
	...
	@Test
	public void toDoDocumentViewSTPPositiveFlow() throws InterruptedException {
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		methodToDoSearchViewSTPPositiveFlow();
	}

	private void methodToDoSearchViewSTPPositiveFlow() throws InterruptedException {
		driver.findElement(By.id("dmsDocViewListSearchBtnId")).click();
		Thread.sleep(1000);
		String doctNameView = properties.getProperty("DOCUMENT_NAME_STP_DOCT_REQUEST");
		boolean isRecordSelected = false;
		int count = 0;
		String applicationWindow = driver.getWindowHandle();
		Thread.sleep(1000);
		isRecordSelected = selectDoctRecdViewSTPPositiveFlow(doctNameView, isRecordSelected, count);
		Thread.sleep(2000);
		if (isRecordSelected) {
	...
	private boolean selectDoctRecdViewSTPPositiveFlow(String doctNameView, boolean isRecordSelected, int count)
