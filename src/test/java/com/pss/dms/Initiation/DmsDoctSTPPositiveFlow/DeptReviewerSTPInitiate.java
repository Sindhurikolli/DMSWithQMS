...
public class DeptReviewerSTPInitiate extends QMSLoginDetails {
	@Test
	public void toDoDeptReviewerSOP() throws InterruptedException {
		Thread.sleep(1000);
...
//        Thread.sleep(1000);
	...
	private void methodToDoDeptReviewerSOP() throws InterruptedException {
		int count = 0;
