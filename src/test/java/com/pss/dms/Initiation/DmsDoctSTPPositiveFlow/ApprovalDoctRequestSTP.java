...
public class ApprovalDoctRequestSTP extends QMSLoginDetails {

	@Test
	public void toDoQAApproverSOP() throws InterruptedException {
		Thread.sleep(1000);
	...
	private void metodToDoQAApproverSOP() throws InterruptedException {
		int count = 0;
