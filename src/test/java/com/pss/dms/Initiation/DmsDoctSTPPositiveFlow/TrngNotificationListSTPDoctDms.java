...
public class TrngNotificationListSTPDoctDms extends QMSLoginDetails {

	@Test
	public void toDoTrainingNotificationListSOP() throws InterruptedException {
		Thread.sleep(1000);
		driver.findElement(By.id("myActivitiesInDMS")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("//*[@id=\"trngNotficationId\"]/a")).click();
		Thread.sleep(3000);
		methodToSelectRecordTrainingNotificationListSOP();

	}

	private void methodToSelectRecordTrainingNotificationListSOP() throws InterruptedException {
		boolean isRecordSelectedTrainingNotification = false;
		int count = 0;
		String documentNameInNotification = properties.getProperty("DOCUMENT_NAME_SOP_DOCT_REQUEST1");
	...
	private void methodToSelectRecordSingleApprovalTrngNotification() throws InterruptedException {
