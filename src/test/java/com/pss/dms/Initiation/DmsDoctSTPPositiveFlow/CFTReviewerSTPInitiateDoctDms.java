...
public class CFTReviewerSTPInitiateDoctDms extends QMSLoginDetails {

	@Test
	public void toDoCFTReviewerSOP() throws InterruptedException {
		Thread.sleep(1000);
	...
	private void metodToDoCFTReviewerSOP() throws InterruptedException {
		int count = 0;
