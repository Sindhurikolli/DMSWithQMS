 ...
 * @author Jeevan
 */
public class MasterListDoctSTPPositiveFlow extends QMSLoginDetails {

	public MasterListDoctSTPPositiveFlow() {
	}
	...
	@Test
	public void toDoMasterListDoctSTPPositiveFlow() throws InterruptedException {
		Thread.sleep(1000);
	...
	private void methodToViewMasterListDoctSTPPositiveFlow() throws InterruptedException {
		...
		int count = 0;
		String doctName = properties.getProperty("DOCUMENT_NAME_STP_DOCT_REQUEST");
		String applicationWindow = driver.getWindowHandle();
		Thread.sleep(1000);
		isRecordSelected = selectedToViewMasterListSTPPositiveRecd(doctName, isRecordSelected, count);
		Thread.sleep(1000);
		if (isRecordSelected) {
	...
	private boolean selectedToViewMasterListSTPPositiveRecd(String doctName, boolean isRecordSelected, int count)
