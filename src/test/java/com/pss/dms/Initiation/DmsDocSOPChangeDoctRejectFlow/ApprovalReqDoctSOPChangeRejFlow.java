 ...
 * @author Jeevan
 */
public class ApprovalReqDoctSOPChangeRejFlow extends QMSLoginDetails {

	public ApprovalReqDoctSOPChangeRejFlow() {
	}
	...
	@Test
	public void toDoApprovalReqDoctSOPChangeRejFlow() throws InterruptedException {
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		methodToDoDocmtApprovalRequestSOPChgeRejectFlow();

	}

	private void methodToDoDocmtApprovalRequestSOPChgeRejectFlow() throws InterruptedException {
		boolean isRecordSelectedForApprovalReq = false;
		int count = 0;
		String documentNameReq = properties.getProperty("DOCUMENT_NAME_SOP_DOCT_REQUEST_CHG_DOCT_REJECT_FLOW");
		isRecordSelectedForApprovalReq = selectRecordDocReqApprovalSOPChgRejectFlow(documentNameReq,
	...
	private boolean selectRecordDocReqApprovalSOPChgRejectFlow(String documentNameReq,
