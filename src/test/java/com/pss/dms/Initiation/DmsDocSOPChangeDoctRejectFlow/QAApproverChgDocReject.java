 ...
 * @author Jeevan
 */
public class QAApproverChgDocReject extends QMSLoginDetails {

	public QAApproverChgDocReject() {
	}
	...
	public void toDoDeptReviewerSOPRejectFlow() throws InterruptedException, IOException, DocumentException, Exception {
		try {
			...
			output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "QAApproverChgDocReject"
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("QAApproverChgDocReject", "PSS-DMS-023", "Pass");
			...
			Thread.sleep(16000);
			metodToDoQAApproverChgSOPDoctRejectFlow();
			document.close();
			writer.close();
	...
	private void metodToDoQAApproverChgSOPDoctRejectFlow() throws Exception {
		int count = 0;
		...
		isRecordSelectedForQAApprover = selectRecordQAApproverSOPStageChgDoctRejFlow(documentDeptSOPReview,
	...
	private boolean selectRecordQAApproverSOPStageChgDoctRejFlow(String documentDeptSOPReview,
