 ...
 * @author Jeevan
 */
public class RejectedCFTReviewApprovalDoctSOPChgRejFlow extends QMSLoginDetails {

	@Test
	public void toCFTReviewerChngDoctReject() throws InterruptedException, IOException, DocumentException, Exception {
		try {

			document = new Document();
			Font font = new Font(Font.FontFamily.TIMES_ROMAN);
			output = System.getProperty("user.dir") + "\\" + "/TestReport/"
					+ "RejectedCFTReviewApprovalDoctSOPChgRejFlow" + (new Random().nextInt()) + ".pdf";
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("RejectedCFTReviewApprovalDoctSOPChgRejFlow",
					"PSS-DMS-028", "Pass");
			...
			metodToDoCFTReviewerApprovalChgSOPDoctRejectFlow();
			document.close();
			writer.close();
	...
	private void metodToDoCFTReviewerApprovalChgSOPDoctRejectFlow() throws Exception {
		int count = 0;
		String documentCFTSOPReview = properties.getProperty("DOCUMENT_NAME_SOP_DOCT_REQUEST_IN_REJECT_FLOW");
		boolean isRecordSelectedForCFTReview = false;
		isRecordSelectedForCFTReview = selectRecordCFTReviewApprovalSOPChgRejectFlow(documentCFTSOPReview,
	...
	private boolean selectRecordCFTReviewApprovalSOPChgRejectFlow(String documentCFTSOPReview,
