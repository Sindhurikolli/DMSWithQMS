 ...
 * @author Jeevan
 */
public class TrngNotificationDocSOPChangeRejectFlow extends QMSLoginDetails {
	...
	public void toDocTrngNotificationListChngDoc()
		...
		try {
			...
			output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "TrngNotificationDocSOPChangeRejectFlow"
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("TrngNotificationDocSOPChangeRejectFlow",
					"PSS-DMS-029", "Pass");
