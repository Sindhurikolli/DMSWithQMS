...
public class DoctTrngApprovalReject extends QMSLoginDetails {

	@Test
	public void toDoctTrngApprovalReject() throws InterruptedException, IOException, DocumentException, Exception {
		try {

			document = new Document();
			Font font = new Font(Font.FontFamily.TIMES_ROMAN);
			output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "DoctTrngApprovalReject"
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("DoctTrngApprovalReject", "PSS-DMS-030", "Pass");
