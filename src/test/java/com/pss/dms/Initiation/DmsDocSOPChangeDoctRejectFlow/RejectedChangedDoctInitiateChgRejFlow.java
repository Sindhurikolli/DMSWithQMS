 ...
 * @author Jeevan
 */
public class RejectedChangedDoctInitiateChgRejFlow extends QMSLoginDetails {

	public RejectedChangedDoctInitiateChgRejFlow() {
	}
	...
	@Test
	public void toDoRejectedChangedDoctInitiateChgRejFlow()
			throws InterruptedException, IOException, DocumentException, Exception {
		try {

			document = new Document();
			Font font = new Font(Font.FontFamily.TIMES_ROMAN);
			output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "RejectedChangedDoctInitiateChgRejFlow"
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("RejectedChangedDoctInitiateChgRejFlow",
					"PSS-DMS-019", "Pass");
	...
	private void methodToDoRejectedDoctInitiateSOPRejectFlow() throws Exception {
		...
		if (isRecordSelectedForDeptReview) {
			...
			Thread.sleep(4000);
			sno++;
			driver.findElement(By.id("versionNoVisibleInChangeDocUpload"))
