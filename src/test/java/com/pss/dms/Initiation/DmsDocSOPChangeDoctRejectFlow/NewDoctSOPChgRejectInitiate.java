 ...
 * @author Jeevan
 */
public class NewDoctSOPChgRejectInitiate extends QMSLoginDetails {

	public NewDoctSOPChgRejectInitiate() {
	}
	...
	@Test
	public void toDoNewDoctSOPChgRejectInitiate() throws InterruptedException {
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		methodToSelectRecordNewDocumentInitiateSOPChgRejectFlow();

	}

	private void methodToSelectRecordNewDocumentInitiateSOPChgRejectFlow() throws InterruptedException {
		int count = 0;
		String documentNameSOPInitiate = properties.getProperty("DOCUMENT_NAME_SOP_DOCT_REQUEST_CHG_DOCT_REJECT_FLOW");
		...
		if (isRecordSelectedDocumentInitiate) {
			...
			driver.findElement(By.id("documentNoOfDocumentUpload"))
					.sendKeys(properties.getProperty("DOCT_NO_INITIATE_NEW_DOCT_SOP_CHG_REJECT_FLOW"));
			Thread.sleep(1000);
			...
			driver.findElement(By.linkText("Next")).click();
			Thread.sleep(2000);
			methodToAddFormatDoctInitiateSOPChgRejectFlow();
		} else {
			System.out.println("Record is not Selected");
		}
	}

	private void methodToAddFormatDoctInitiateSOPChgRejectFlow() throws InterruptedException {
		...
		driver.findElement(By.id("createFormatName1"))
				.sendKeys(properties.getProperty("DOCT_NAME_FORMAT_SOP_CHG_REJECT_FLOW"));
		Thread.sleep(1000);
		driver.findElement(By.linkText("Next")).click();
		Thread.sleep(2000);
