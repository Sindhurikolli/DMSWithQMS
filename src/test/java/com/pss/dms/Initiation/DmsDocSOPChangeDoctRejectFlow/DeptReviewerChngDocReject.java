 ...
 * @author Jeevan
 */
public class DeptReviewerChngDocReject extends QMSLoginDetails {

	public DeptReviewerChngDocReject() {
	}
	...
	public void toDoDeptReviewerSOPRejectFlow() throws InterruptedException, IOException, DocumentException, Exception {
		try {
			...
			output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "DeptReviewerChngDocReject"
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("DeptReviewerChngDocReject", "PSS-DMS-017", "Pass");
