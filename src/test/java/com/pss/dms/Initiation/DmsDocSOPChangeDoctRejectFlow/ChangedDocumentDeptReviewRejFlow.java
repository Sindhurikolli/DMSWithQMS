 ...
 * @author Jeevan
 */
public class ChangedDocumentDeptReviewRejFlow extends QMSLoginDetails {

	public ChangedDocumentDeptReviewRejFlow() {
	}
	...
	@Test
	public void toDoChangedDocumentDeptReviewRejFlow() throws InterruptedException {
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		methodToSelectRecordDeptReviewRejFlow();
		Thread.sleep(1000);
		driver.manage().deleteAllCookies();
		Thread.sleep(1000);
	}

	private void methodToSelectRecordDeptReviewRejFlow() throws InterruptedException {
		int count = 0;
		...
		isRecordSelectedForDeptReview = selectChgDoctSOPRejFlowRecord(documentDeptSOPReview,
	...
	private boolean selectChgDoctSOPRejFlowRecord(String documentDeptSOPReview, boolean isRecordSelectedForDeptReview,
