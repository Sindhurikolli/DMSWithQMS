 ...
 * @author Jeevan
 */
public class CQAApproverChgSOPDoctRejectFlow extends QMSLoginDetails {

	public CQAApproverChgSOPDoctRejectFlow() {
	}
	...
	@Test
	public void toDoCQAApproverChgSOPDoctRejectFlow() throws InterruptedException {
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		metodToDoCQAApproverChgSOPDoctRejectFlow();
		Thread.sleep(1000);
		driver.manage().deleteAllCookies();
		Thread.sleep(1000);
	}

	private void metodToDoCQAApproverChgSOPDoctRejectFlow() throws InterruptedException {
		int count = 0;
		...
		isRecordSelectedForCQAApprover = selectRecordCQApproverSOPStageChgDoctRejectFlow(documentDeptSOPReview,
	...
	private boolean selectRecordCQApproverSOPStageChgDoctRejectFlow(String documentDeptSOPReview,
