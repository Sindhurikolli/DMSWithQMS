 ...
 * @author Jeevan
 */
public class CreateDoctRequestSOPChgeDoctRejFlow extends QMSLoginDetails {

	public CreateDoctRequestSOPChgeDoctRejFlow() {
	}
	...
	@Test
	public void toDoCreateDoctRequestSOPChgeDoctRejFlow() throws InterruptedException {
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		metodToCreateDoctRequestSOPChgeDoctRejFlow();

	}

	private void metodToCreateDoctRequestSOPChgeDoctRejFlow() throws InterruptedException {
		driver.findElement(By.id("documentNameInNewDocRequestPage"))
				.sendKeys(properties.getProperty("DOCUMENT_NAME_SOP_DOCT_REQUEST_CHG_DOCT_REJECT_FLOW"));
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		methodToSelectSingleApprovalDoctChgDoctSOPRejectFlow();

	}

	private void methodToSelectSingleApprovalDoctChgDoctSOPRejectFlow() throws InterruptedException {
		driver.findElement(By.id("selectRepToInCreateUser")).click();
		Thread.sleep(1000);
		boolean isRecordSelectedSingleApprovalDoctReqChgDocSOPRejectFlow = false;
		...
		isRecordSelectedSingleApprovalDoctReqChgDocSOPRejectFlow = Helper.selectSingleApprovalRecord(driver,
				userSingleApprovalName, isRecordSelectedSingleApprovalDoctReqChgDocSOPRejectFlow, count);
		Thread.sleep(1000);
		if (isRecordSelectedSingleApprovalDoctReqChgDocSOPRejectFlow) {
