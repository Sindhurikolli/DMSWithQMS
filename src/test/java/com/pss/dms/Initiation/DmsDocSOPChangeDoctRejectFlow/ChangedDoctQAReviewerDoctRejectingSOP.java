 ...
 * @author Jeevan
 */
public class ChangedDoctQAReviewerDoctRejectingSOP extends QMSLoginDetails {

	public ChangedDoctQAReviewerDoctRejectingSOP() {
	}
	...
	@Test
	public void toDoChangedDoctQAReviewerDoctRejectingSOP() throws InterruptedException {
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		methodToSelectRecordQAReviewRejectedRejFlow();

	}

	private void methodToSelectRecordQAReviewRejectedRejFlow() throws InterruptedException {
		int count = 0;
		String documentQASOPReview = properties.getProperty("DOCUMENT_NAME_SOP_DOCT_REQUEST_CHG_DOCT_REJECT_FLOW");
	...
	private boolean selectRecordQAReviewForRejectingChgDmt(String documentQASOPReview,
		...
		WebElement table = driver.findElement(By.id("changeDocReviewTable"));// *[@id="changeDocReviewTable"]/div/table/tbody/tr/td[2]
