 ...
 * @author Jeevan
 */
public class DmsSTPDoctDeptReviewChgRejectFlow extends QMSLoginDetails {

	public DmsSTPDoctDeptReviewChgRejectFlow() {
	}
	...
	@Test
	public void toDoDmsSTPDoctDeptReviewChgRejectFlow() throws InterruptedException {
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		methodToDoDeptReviewerSTPChgRejectFlow();
		Thread.sleep(1000);
		driver.manage().deleteAllCookies();
		Thread.sleep(1000);
	}

	private void methodToDoDeptReviewerSTPChgRejectFlow() throws InterruptedException {
		int count = 0;
		...
		isRecordSelectedForDeptReview = selectRecordDeptReviewStageSTPChgRejectFlow(documentDeptSTPReview,
	...
	private boolean selectRecordDeptReviewStageSTPChgRejectFlow(String documentDeptSOPReview,
