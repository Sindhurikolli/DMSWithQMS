 ...
 * @author Jeevan
 */
public class RejectedCFTReviewerSTPChgeRejectFlow extends QMSLoginDetails {

	public RejectedCFTReviewerSTPChgeRejectFlow() {
	}
	...
	//
	@Test
	public void toDoRejectedCFTReviewerSTPChgeRejectFlow() throws InterruptedException {
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		metodToDoCFTReviewerApprovalChgSTPDoctRejectFlow();
		Thread.sleep(1000);
	...
	private void metodToDoCFTReviewerApprovalChgSTPDoctRejectFlow() throws InterruptedException {
		int count = 0;
		String documentCFTSOPReview = properties.getProperty("DOCUMENT_NAME_STP_DOCT_REQUEST_CHG_DOCT_REJECT_FLOW");
		boolean isRecordSelectedForCFTReview = false;
		isRecordSelectedForCFTReview = selectRecordCFTReviewApprovalSTPChgRejectFlow(documentCFTSOPReview,
	...
	private boolean selectRecordCFTReviewApprovalSTPChgRejectFlow(String documentCFTSOPReview,
