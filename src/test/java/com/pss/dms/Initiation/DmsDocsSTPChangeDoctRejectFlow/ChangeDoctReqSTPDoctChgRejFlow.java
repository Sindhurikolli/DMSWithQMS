 ...
 * @author Jeevan
 */
public class ChangeDoctReqSTPDoctChgRejFlow extends QMSLoginDetails {

	public ChangeDoctReqSTPDoctChgRejFlow() {
	}
	...
	@Test
	public void toDoChangeDoctReqSTPDoctChgRejFlow() throws InterruptedException {
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		methodToDoSelectChangeDoctReqSTPChgRejFlow();

	}

	private void methodToDoSelectChangeDoctReqSTPChgRejFlow() throws InterruptedException {
		...
		Thread.sleep(1000);
		methodToSelectDoctChangeDoctReqSTPChgRejFlow();
	}

	private void methodToSelectDoctChangeDoctReqSTPChgRejFlow() throws InterruptedException {
		boolean isRecordSelected = false;
		int count = 0;
		String selectDmtNameForChgDoct = properties.getProperty("DOCUMENT_NAME_STP_DOCT_REQUEST_CHG_DOCT_REJECT_FLOW");
		isRecordSelected = selectRecordDoctChangeDoctReqSTPChgRejFlow(selectDmtNameForChgDoct, isRecordSelected, count);
		Thread.sleep(1000);
		if (isRecordSelected) {
	...
	private boolean selectRecordDoctChangeDoctReqSTPChgRejFlow(String selectDmtNameForChgDoct, boolean isRecordSelected,
			int count) {
