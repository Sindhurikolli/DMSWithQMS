 ...
 * @author Jeevan
 */
public class QAReviewerSTPChgRejectFlow extends QMSLoginDetails {

	public QAReviewerSTPChgRejectFlow() {
	}
	...
	@Test
	public void toDoQAReviewerSTPChgRejectFlow() throws InterruptedException {
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		methodToDoQAReviewerChgSTPDoctRejFlow();
		Thread.sleep(1000);
	...
	private void methodToDoQAReviewerChgSTPDoctRejFlow() throws InterruptedException {
		int count = 0;
		String documentDeptSTPReview = properties.getProperty("DOCUMENT_NAME_STP_DOCT_REQUEST_CHG_DOCT_REJECT_FLOW");
		boolean isRecordSelectedForQAReview = false;
		isRecordSelectedForQAReview = selectRecordQAReviewStageSTPChgRejectFlow(documentDeptSTPReview,
	...
	private boolean selectRecordQAReviewStageSTPChgRejectFlow(String documentQASTPReview,
