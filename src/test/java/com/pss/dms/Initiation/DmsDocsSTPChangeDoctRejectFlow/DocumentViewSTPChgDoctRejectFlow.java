 ...
 * @author Jeevan
 */
public class DocumentViewSTPChgDoctRejectFlow extends QMSLoginDetails {

	public DocumentViewSTPChgDoctRejectFlow() {
	}
	...
	@Test
	public void toDoDocumentViewChgDoctRejectFlow() throws InterruptedException {
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		methodToDoSearchViewSTPChgDoctRejectFlow();
	}

	private void methodToDoSearchViewSTPChgDoctRejectFlow() throws InterruptedException {
		driver.findElement(By.id("dmsDocViewListSearchBtnId")).click();
		Thread.sleep(1000);
		String doctNameView = properties.getProperty("DOCUMENT_NAME_STP_DOCT_REQUEST_CHG_DOCT_REJECT_FLOW");
		boolean isRecordSelected = false;
		int count = 0;
		String applicationWindow = driver.getWindowHandle();
		Thread.sleep(1000);
		isRecordSelected = selectDoctRecdViewSTPChgDoctRejFlow(doctNameView, isRecordSelected, count);
		Thread.sleep(2000);
		if (isRecordSelected) {
	...
	private boolean selectDoctRecdViewSTPChgDoctRejFlow(String doctNameView, boolean isRecordSelected, int count)
