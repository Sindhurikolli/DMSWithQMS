 ...
 * @author Jeevan
 */
public class TrngNotificationSTPChgDoctRejectFlow extends QMSLoginDetails {
	...
	private void methodToSelectRecordTrainingNotificationListSTPChgDoctRejectFlow() throws InterruptedException {
		...
		isRecordSelectedTrainingNotification = selectRecordTrngNotificationSTPDoctRejectFlow(documentNameInNotification,
	...
	private boolean selectRecordTrngNotificationSTPDoctRejectFlow(String documentNameInNotification,
