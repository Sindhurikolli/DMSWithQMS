 ...
 * @author Jeevan
 */
public class CFTReviewerSTPChgRejectFlow extends QMSLoginDetails {

	public CFTReviewerSTPChgRejectFlow() {
	}
	...
	@Test
	public void toDoCFTReviewerSTPChgRejectFlow() throws InterruptedException {
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		metodToDoCFTReviewerChgSTPDoctRejectFlow();
		Thread.sleep(1000);
	...
	private void metodToDoCFTReviewerChgSTPDoctRejectFlow() throws InterruptedException {
		int count = 0;
		String documentCFTSTPReview = properties.getProperty("DOCUMENT_NAME_STP_DOCT_REQUEST_CHG_DOCT_REJECT_FLOW");
		boolean isRecordSelectedForCFTReview = false;
		isRecordSelectedForCFTReview = selectRecordCFTReviewStageChgSTPRejectFlow(documentCFTSTPReview,
...
//            List<WebElement> list=driver.findElements(By.id("continueBtnInNewDocRevForm"));
...
//                    wait1.until(ExpectedConditions.presenceOfElementLocated(By.id("approveBtnDocRevAnnotsWin")));
	...
	private boolean selectRecordCFTReviewStageChgSTPRejectFlow(String documentDeptSOPReview,
