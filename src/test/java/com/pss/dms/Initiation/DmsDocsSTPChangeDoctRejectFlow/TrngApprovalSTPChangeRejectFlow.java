 ...
 * @author Jeevan
 */
public class TrngApprovalSTPChangeRejectFlow extends QMSLoginDetails {

	public TrngApprovalSTPChangeRejectFlow() {
	}
	...
	@Test
	public void toDoTrngApprovalSTPChangeRejectFlow() throws InterruptedException {
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		methodToSelectRecordToDoTrngApprovalDoctSTPChgRejFlow();
	}

	private void methodToSelectRecordToDoTrngApprovalDoctSTPChgRejFlow() throws InterruptedException {
		boolean isRecordSelectedTrngApprovalSTP = false;
		int count = 0;
		String doctNameTrngApprovalSTP = properties.getProperty("DOCUMENT_NAME_STP_DOCT_REQUEST_CHG_DOCT_REJECT_FLOW");
		isRecordSelectedTrngApprovalSTP = selectRecordToDOTrngApprovalSTPDoctChgRejFlow(doctNameTrngApprovalSTP,
				isRecordSelectedTrngApprovalSTP, count);
		Thread.sleep(1000);
		if (isRecordSelectedTrngApprovalSTP) {
	...
	private boolean selectRecordToDOTrngApprovalSTPDoctChgRejFlow(String doctNameTrngApprovalSOP,
