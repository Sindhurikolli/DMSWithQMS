 ...
 * @author Jeevan
 */
public class NewSTPDoctReqApprovalChgDoctRejFlow extends QMSLoginDetails {

	public NewSTPDoctReqApprovalChgDoctRejFlow() {
	}
	...
	@Test
	public void toDoNewSTPDoctReqApprovalChgDoctRejFlow() throws InterruptedException {
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		methodToDoDmsDoctApprovalReqSOPChgRejFlow();
	}

	private void methodToDoDmsDoctApprovalReqSOPChgRejFlow() throws InterruptedException {
		boolean isRecordSelectedForApprovalReq = false;
		int count = 0;
		String documentNameReq = properties.getProperty("DOCUMENT_NAME_STP_DOCT_REQUEST_CHG_DOCT_REJECT_FLOW");
		isRecordSelectedForApprovalReq = selectRecordDocReqApprovalSTPChgRejectFlow(documentNameReq,
	...
	private boolean selectRecordDocReqApprovalSTPChgRejectFlow(String documentNameReq,
