 ...
 * @author Jeevan
 */
public class ChangedDoctInitiateSTPChangedRejFlow extends QMSLoginDetails {

	public ChangedDoctInitiateSTPChangedRejFlow() {
	}
	...
	@Test
	public void toDoChangedDoctInitiateSTPChangedRejFlow() throws InterruptedException {
		...
		Thread.sleep(1000);
		methodToSelectRecordSTPForChgDmtInitiateRejFlow();
		Thread.sleep(1000);

	}

	private void methodToSelectRecordSTPForChgDmtInitiateRejFlow() throws InterruptedException {
		...
		isRecordSelectedChgDmtInitiation = selectRecordSTPChgReqDtlsTableRejFlow(documentName,
	...
	private boolean selectRecordSTPChgReqDtlsTableRejFlow(String documentName, boolean isRecordSelectedChgDmtInitiation,
