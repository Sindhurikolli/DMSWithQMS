 ...
 * @author Jeevan
 */
public class ChangedDoctSTPDeptReviewerRejFlow extends QMSLoginDetails {

	public ChangedDoctSTPDeptReviewerRejFlow() {
	}
	...
	@Test
	public void toDoChangedDoctSTPDeptReviewerRejFlow() throws InterruptedException {
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		methodToSelectRecordSTPDoctDeptReviewRejFlow();
		Thread.sleep(1000);
	...
	private void methodToSelectRecordSTPDoctDeptReviewRejFlow() throws InterruptedException {
		int count = 0;
		String documentDeptSOPReview = properties.getProperty("DOCUMENT_NAME_STP_DOCT_REQUEST_CHG_DOCT_REJECT_FLOW");
		boolean isRecordSelectedForDeptReview = false;
		isRecordSelectedForDeptReview = selectChgDoctSTPRejFlowRecord(documentDeptSOPReview,
	...
	private boolean selectChgDoctSTPRejFlowRecord(String documentDeptSOPReview, boolean isRecordSelectedForDeptReview,
