 ...
 * @author Jeevan
 */
public class NewDoctSTPInitiateChgRejectFlow extends QMSLoginDetails {

	public NewDoctSTPInitiateChgRejectFlow() {
	}
	...
	@Test
	public void toDoNewDoctSTPInitiateChgRejectFlow() throws InterruptedException {
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		methodToSelectRecordNewDocumentInitiateSTPChgRejectFlow();
	}

	private void methodToSelectRecordNewDocumentInitiateSTPChgRejectFlow() throws InterruptedException {
		int count = 0;
		String documentNameSOPInitiate = properties.getProperty("DOCUMENT_NAME_STP_DOCT_REQUEST_CHG_DOCT_REJECT_FLOW");
		...
		if (isRecordSelectedDocumentInitiate) {
			...
			driver.findElement(By.id("documentNoOfDocumentUpload"))
					.sendKeys(properties.getProperty("DOCT_NO_INITIATE_NEW_DOCT_STP_CHG_REJECT_FLOW"));
			Thread.sleep(1000);
			...
			driver.findElement(By.linkText("Next")).click();
			Thread.sleep(2000);
			methodToAddFormatDoctInitiateSTPChgRejectFlow();
		} else {
			System.out.println("Record is not Selected");
		}
	}

	private void methodToAddFormatDoctInitiateSTPChgRejectFlow() throws InterruptedException {
		...
		driver.findElement(By.id("createFormatName1"))
				.sendKeys(properties.getProperty("DOCT_NAME_FORMAT_STP_CHG_REJECT_FLOW"));
		Thread.sleep(1000);
		driver.findElement(By.linkText("Next")).click();
		Thread.sleep(2000);
