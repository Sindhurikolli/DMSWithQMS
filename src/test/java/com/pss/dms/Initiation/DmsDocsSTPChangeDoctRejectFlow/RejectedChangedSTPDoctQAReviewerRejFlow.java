 ...
 * @author Jeevan
 */
public class RejectedChangedSTPDoctQAReviewerRejFlow extends QMSLoginDetails {

	public RejectedChangedSTPDoctQAReviewerRejFlow() {
	}
	...
	@Test
	public void toDoRejectedChangedSTPDoctQAReviewerRejFlow() throws InterruptedException {
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		methodToSelectRecordQAReviewRejFlowSTP();
		Thread.sleep(1000);
		driver.manage().deleteAllCookies();
		Thread.sleep(1000);
	}

	private void methodToSelectRecordQAReviewRejFlowSTP() throws InterruptedException {
		int count = 0;
		...
		isRecordSelectedForQAReview = selectRecQAReviewApprovalSTPChgRejFlow(documentDeptSOPReview,
	...
	private boolean selectRecQAReviewApprovalSTPChgRejFlow(String documentDeptSOPReview,
