...
public class TermDoctInitiate extends QMSLoginDetails {
	...
	public void toChangeDoctInitiate() throws InterruptedException, IOException, DocumentException, Exception {
		try {
			...
			output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "TermDoctInitiate"
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("TermDoctInitiate", "PSS-DMS-005", "Pass");
			...
			wait1.until(ExpectedConditions.invisibilityOf(driver.findElement(
					By.cssSelector("#terminateDocumentInitiateReqGridId > div > div.jtable-busy-message"))));
	...
	private void methodToSelectRecordForChgDmtInitiate() throws Exception {
		...
		int count = 0;
		String documentName = properties.getProperty("DOCUMENT_NAME_SOP_TERM_DOCT");
