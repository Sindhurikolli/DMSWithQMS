...
public class QAreviewerTermDocument extends QMSLoginDetails {

	@Test
	public void toQAReviewerTermDocument() throws InterruptedException, IOException, DocumentException, Exception {
		try {

			document = new Document();
			Font font = new Font(Font.FontFamily.TIMES_ROMAN);
			output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "QAReviewerTermDocument"
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("QAReviewerTermDocument", "PSS-DMS-007", "Pass");
