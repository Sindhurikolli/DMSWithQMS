...
public class DeptreviewerTermDoctReject extends QMSLoginDetails {

	@Test
	public void toDeptreviewerTermDoctReject() throws InterruptedException, IOException, DocumentException, Exception {
		try {

			document = new Document();
			Font font = new Font(Font.FontFamily.TIMES_ROMAN);
			output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "DeptreviewerTermDoctReject"
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("DeptreviewerTermDoctReject", "PSS-DMS-015",
					"Pass");
	...
	private void methodToSelectChgDoctRecordDeptReviewApprovalFlow() throws Exception {
		...
		if (isRecordSelectedForDeptReview) {
			...
			Thread.sleep(1000);
			driver.findElement(By.id("rejectInReviseDocReviewPage")).click();
