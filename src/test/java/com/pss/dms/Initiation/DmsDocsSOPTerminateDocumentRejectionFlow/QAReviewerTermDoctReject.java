...
public class QAReviewerTermDoctReject extends QMSLoginDetails {

	@Test
	public void toQAReviewerTermDoctReject() throws InterruptedException, IOException, DocumentException, Exception {
		try {

			document = new Document();
			Font font = new Font(Font.FontFamily.TIMES_ROMAN);
			output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "QAReviewerTermDoctReject"
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("QAReviewerTermDoctReject", "PSS-DMS-018", "Pass");
