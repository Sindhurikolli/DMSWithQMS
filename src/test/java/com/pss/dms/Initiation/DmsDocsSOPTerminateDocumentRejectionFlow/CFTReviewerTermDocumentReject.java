...
public class CFTReviewerTermDocumentReject extends QMSLoginDetails {
	...
	public void toCFTReviewerTermDocument() throws InterruptedException, IOException, DocumentException, Exception {
		try {
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("CFTReviewerTermDocument", "PSS-DMS-020", "Pass");
