...
public class QAReviewerCC extends QMSLoginDetails {
	...
	public void toQAReviewerCC() throws InterruptedException, IOException, DocumentException, Exception {
		try {
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("QAReviewerCC", "PSS-QMS-012", "Pass");
...
//        String chgControlNumber = chgCtrlNoWithPlantCode + sdf + chgCtrlId;
		...
		if (isRecordSelected) {
			...
			driver.findElement(By.xpath("//*[@id=\"docDetailsTableNewInCcRev\"]/div/div[3]/div[2]/span[3]/span[2]"))
					.click();
			document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on Terminate document", sno,
					false);
			Thread.sleep(32000);
			sno++;
			...
			String ChngDocNo = properties.getProperty("DOCUMENT_NAME_SOP_TERM_DOCT");
