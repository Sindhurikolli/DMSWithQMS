...
public class DeptReviewerTermDoct extends QMSLoginDetails {
	...
	public void toDeptReviewerTermDocument() throws InterruptedException, IOException, DocumentException, Exception {
		try {
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("DeptReviewerTermDocument", "PSS-DMS-017", "Pass");
