...
public class QAApproverTermDocumentReject extends QMSLoginDetails {

	@Test
	public void toQAApproverTermDocumentReject()
			throws InterruptedException, IOException, DocumentException, Exception {
		try {

			document = new Document();
			Font font = new Font(Font.FontFamily.TIMES_ROMAN);
			output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "QAApproverTermDocumentReject"
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("QAApproverTermDocumentReject", "PSS-DMS-022",
					"Pass");
