...
public class DocmtApprovalRequestSOP extends QMSLoginDetails {

	@Test
	public void toDoDocmtApprovalRequestSOP() throws InterruptedException, IOException, DocumentException, Exception {
		try {
