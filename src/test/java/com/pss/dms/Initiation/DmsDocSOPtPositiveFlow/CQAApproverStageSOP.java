 ...
 * @author Jeevan
 */
public class CQAApproverStageSOP extends QMSLoginDetails {

	public CQAApproverStageSOP() {
	}
	...
	@Test
	public void toDoCQAApproverStageSOP() throws InterruptedException {
		Thread.sleep(1000);
		...
		metodToDoCQAApproverSOP();

	}

	private void metodToDoCQAApproverSOP() throws InterruptedException {
		int count = 0;
		...
		isRecordSelectedForCQAApprover = selectRecordCQApproverSOPStage(documentDeptSOPReview,
	...
	private boolean selectRecordCQApproverSOPStage(String documentDeptSOPReview, boolean isRecordSelectedForCQAApprover,
