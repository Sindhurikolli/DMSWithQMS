...
public class QAReviewerSOP extends QMSLoginDetails {

	@Test
	public void toDoQAReviewerSOP() throws InterruptedException, IOException, DocumentException, Exception {
		try {
...
//        Thread.sleep(4000);
	...
	private void metodToDoQAReviewerSOP() throws Exception {
		sno++;
		int count = 0;
