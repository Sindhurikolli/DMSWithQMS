...
public class DeptReviewerSOP extends QMSLoginDetails {
	@Test
	public void toDoDeptReviewerSOP() throws InterruptedException, IOException, DocumentException, Exception {
		try {

			document = new Document();
			Font font = new Font(Font.FontFamily.TIMES_ROMAN);
			output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "DeptReviewerSOP"
...
//        sno++;
	...
	private void methodToDoDeptReviewerSOP() throws Exception {
		sno++;
		int count = 0;
