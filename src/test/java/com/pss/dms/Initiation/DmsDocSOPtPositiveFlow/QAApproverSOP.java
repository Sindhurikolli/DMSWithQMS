...
public class QAApproverSOP extends QMSLoginDetails {

	@Test
	public void toDoQAApproverSOP() throws InterruptedException, IOException, DocumentException, Exception {
		try {

			document = new Document();
			Font font = new Font(Font.FontFamily.TIMES_ROMAN);
			output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "QAApproverSOP" + (new Random().nextInt())
					+ ".pdf";
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("QAApproverSOP", "PSS-DMS-009", "Pass");
...
//        document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on New Document menu", sno,false);
	...
	private void metodToDoQAApproverSOP() throws Exception {
		sno++;
		int count = 0;
