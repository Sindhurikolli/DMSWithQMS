...
public class CFTReviewerSOP extends QMSLoginDetails {

	@Test
	public void toDoCFTReviewerSOP() throws InterruptedException, IOException, DocumentException, Exception {
		try {

			document = new Document();
			Font font = new Font(Font.FontFamily.TIMES_ROMAN);
			output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "CFTReviewerSOP"
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("CFTReviewerSOP", "PSS-DMS-008", "Pass");
...
//        document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on New Document menu", sno,false);
	...
	private void metodToDoCFTReviewerSOP() throws Exception {
		sno++;
		int count = 0;
