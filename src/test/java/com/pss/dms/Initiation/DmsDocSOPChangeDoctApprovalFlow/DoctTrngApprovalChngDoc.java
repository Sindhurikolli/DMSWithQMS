 ...
 * @author Jeevan
 */
public class DoctTrngApprovalChngDoc extends QMSLoginDetails {
	...
	public void toDoctTrngApprovalChngDoc() throws InterruptedException, IOException, DocumentException, Exception {
		try {
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("DoctTrngApprovalChngDoc", "PSS-DMS-010", "Pass");
