 ...
 * @author Jeevan
 */
public class CFTReviewerSOPChgDoctPositiveFlow extends QMSLoginDetails {

	public CFTReviewerSOPChgDoctPositiveFlow() {
	}
	...
	@Test
	public void toDoCFTReviewerSOPChgDoctPositiveFlow() throws InterruptedException {
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		metodToDoCFTReviewerSOPChgDoctPositiveFlw();

	}

	private void metodToDoCFTReviewerSOPChgDoctPositiveFlw() throws InterruptedException {
		int count = 0;
		...
		isRecordSelectedForCFTReview = selectRecordCFTReviewStageSOPChgDoctPositiveFlw(documentDeptSOPReview,
	...
	private boolean selectRecordCFTReviewStageSOPChgDoctPositiveFlw(String documentDeptSOPReview,
