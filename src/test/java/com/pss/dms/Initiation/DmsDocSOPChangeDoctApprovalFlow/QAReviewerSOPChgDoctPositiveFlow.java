 ...
 * @author Jeevan
 */
public class QAReviewerSOPChgDoctPositiveFlow extends QMSLoginDetails {

	public QAReviewerSOPChgDoctPositiveFlow() {
	}
	...
	//
	@Test
	public void toDoQAReviewerSOPChgDoctPositiveFlow() throws InterruptedException {
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		metodToDoQAReviewerSOPChgDoctPositiveFlw();

	}

	private void metodToDoQAReviewerSOPChgDoctPositiveFlw() throws InterruptedException {
		int count = 0;
		...
		isRecordSelectedForQAReview = selectRecordQAReviewStageChgDoctPositiveFlow(documentDeptSOPReview,
	...
	private boolean selectRecordQAReviewStageChgDoctPositiveFlow(String documentDeptSOPReview,
