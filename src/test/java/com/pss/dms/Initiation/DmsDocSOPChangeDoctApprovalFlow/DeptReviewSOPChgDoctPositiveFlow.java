 ...
 * @author Jeevan
 */
public class DeptReviewSOPChgDoctPositiveFlow extends QMSLoginDetails {

	public DeptReviewSOPChgDoctPositiveFlow() {
	}
	...
	@Test
	public void toDoDeptReviewSOPChgDoctPositiveFlow() throws InterruptedException {
		Thread.sleep(1000);
		...
		methodToDoDeptReviewerSOPDoctPositiveFlw();
	}

	private void methodToDoDeptReviewerSOPDoctPositiveFlw() throws InterruptedException {
		int count = 0;
		...
		isRecordSelectedForDeptReview = selectRecordDeptReviewStagePositiveFlow(documentDeptSOPReview,
	...
	private boolean selectRecordDeptReviewStagePositiveFlow(String documentDeptSOPReview,
