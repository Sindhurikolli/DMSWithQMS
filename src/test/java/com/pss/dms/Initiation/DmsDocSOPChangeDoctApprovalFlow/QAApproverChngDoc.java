 ...
 * @author Jeevan
 */
public class QAApproverChngDoc extends QMSLoginDetails {
	...
	public void toCFTReviewerChngDoc() throws InterruptedException, IOException, DocumentException, Exception {
		try {
			...
			metodToDoQAApproverApprovalChgSOPDoctApprovalFlow();
			document.close();
			writer.close();
	...
	private void metodToDoQAApproverApprovalChgSOPDoctApprovalFlow() throws Exception {
		int count = 0;
		String documentQASOPApprover = properties.getProperty("DOCUMENT_NAME_SOP_DOCT_REQUEST");
		boolean isRecordSelectedForQAApprover = false;
		isRecordSelectedForQAApprover = selectRecQAReviewSOPChgDoctApprovalFlow(documentQASOPApprover,
	...
	private boolean selectRecQAReviewSOPChgDoctApprovalFlow(String documentQASOPApprover,
