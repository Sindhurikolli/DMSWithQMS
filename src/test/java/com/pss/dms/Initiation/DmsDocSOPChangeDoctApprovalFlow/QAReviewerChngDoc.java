 ...
 * @author Jeevan
 */
public class QAReviewerChngDoc extends QMSLoginDetails {
	...
	public void toQAReviewerChngDoc() throws InterruptedException, IOException, DocumentException, Exception {
		try {
			...
			output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "QAReviewerChngDoc"
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("QAReviewerChngDoc", "PSS-DMS-007", "Pass");
	...
	private void methodToSelectRecdQAReviewApprovalFlowSOP() throws Exception {
		...
		isRecordSelectedForQAReview = selectRecQAReviewApprovalSOPChgApprovalFlow(documentDeptSOPReview,
	...
	private boolean selectRecQAReviewApprovalSOPChgApprovalFlow(String documentDeptSOPReview,
