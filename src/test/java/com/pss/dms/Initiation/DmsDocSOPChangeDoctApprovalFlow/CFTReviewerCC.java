...
public class CFTReviewerCC extends QMSLoginDetails {
...
//        WebDriverWait wait1 = new WebDriverWait(driver, 420);
			wait1.until(ExpectedConditions.invisibilityOf(driver.findElement(
					By.cssSelector("#changeControlCftReviewTableContainer > div > div.jtable-busy-message"))));
...
//	        System.out.println("CC Number is coming........:"+CCNumber);
		...
		if (isRecordSelected) {
			...
			document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Submit button", sno, false);
			Thread.sleep(5000);
			sno++;
				...
				if (totalNoOfRecords > 1) {
					...
					if (chgControlNumber.equalsIgnoreCase(CCNumberSequence)) {
						driver.findElement(By.xpath(
								".//*[@id='changeControlCftReviewTableContainer']/div/table/tbody/tr/td[50]/button"))
								.click();
						isRecordSelected = true;
						break;
					}
