...
public class ActionItemPerform extends QMSLoginDetails {
	...
	@Test
	public void toActionItemPerform() throws InterruptedException, IOException, DocumentException, Exception {
		try {
...
//        Thread.sleep(100000);
			...
			wait1.until(ExpectedConditions.invisibilityOf(driver
					.findElement(By.cssSelector("#changeControlActItmPerFormTable > div > div.jtable-busy-message"))));
