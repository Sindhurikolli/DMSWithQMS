 ...
 * @author Jeevan
 */
public class CQAApproverSOPChgDoctPositiveFlw extends QMSLoginDetails {

	public CQAApproverSOPChgDoctPositiveFlw() {
	}
	...
	@Test
	public void toDoCQAApproverSOPChgDoctPositiveFlw() throws InterruptedException {
		Thread.sleep(1000);
		...
		metodToDoCQAApproverSOPChgDoctPositiveFlw();

	}

	private void metodToDoCQAApproverSOPChgDoctPositiveFlw() throws InterruptedException {
		int count = 0;
		...
		isRecordSelectedForCQAApprover = selectRecordCQApproverSOPStageSOPChgDoctPositiveFlw(documentDeptSOPReview,
	...
	private boolean selectRecordCQApproverSOPStageSOPChgDoctPositiveFlw(String documentDeptSOPReview,
