 ...
 * @author Jeevan
 */
public class ChangeDoctSOPCQAApproverApprovalFlow extends QMSLoginDetails {

	public ChangeDoctSOPCQAApproverApprovalFlow() {
	}
	...
	@Test
	public void toDoChangeDoctSOPCQAApproverApprovalFlow() throws InterruptedException {
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		methodToSelectRecordCQAChgApprovalFlowSOP();
		Thread.sleep(1000);
	...
	private void methodToSelectRecordCQAChgApprovalFlowSOP() throws InterruptedException {
		int count = 0;
		String documentDeptSOPReview = properties.getProperty("DOCUMENT_NAME_SOP_DOCT_REQUEST_CHG_DOCT_APPROVAL_FLOW");
		boolean isRecordSelectedForCQAApprover = false;
		isRecordSelectedForCQAApprover = selectRecQAApproverApprovalSOPChgApprovalFlow(documentDeptSOPReview,
	...
	private boolean selectRecQAApproverApprovalSOPChgApprovalFlow(String documentDeptSOPReview,
