 ...
 * @author Jeevan
 */
public class MasterDoctSOPChgDoctApprovalFlow extends QMSLoginDetails {

	public MasterDoctSOPChgDoctApprovalFlow() {
	}
	...
	@Test
	public void toDoMasterDoctSOPChgDoctApprovalFlow() throws InterruptedException {
		Thread.sleep(1000);
		driver.findElement(By.id("bmrHomeInCommonHPHeader")).click();
		Thread.sleep(1000);
		driver.findElement(By.id("masterListTabIdInDMS")).click();
		Thread.sleep(1000);
		methodToViewMasterListChangeDoctSOPApprovalFlow();
	}

	private void methodToViewMasterListChangeDoctSOPApprovalFlow() throws InterruptedException {
		driver.findElement(By.id("tree_1_span")).click();
		Thread.sleep(1000);
		boolean isRecordSelected = false;
		int count = 0;
		String doctName = properties.getProperty("DOCUMENT_NAME_SOP_DOCT_REQUEST_CHG_DOCT_APPROVAL_FLOW");
		String applicationWindow = driver.getWindowHandle();
		Thread.sleep(1000);
		isRecordSelected = selectRecordToViewMasterListChgDoctSOPApprovalFlow(doctName, isRecordSelected, count);
		Thread.sleep(1000);
		if (isRecordSelected) {
	...
	private boolean selectRecordToViewMasterListChgDoctSOPApprovalFlow(String doctName, boolean isRecordSelected,
