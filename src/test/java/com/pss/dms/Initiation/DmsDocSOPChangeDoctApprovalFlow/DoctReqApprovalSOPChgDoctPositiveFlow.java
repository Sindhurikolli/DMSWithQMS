 ...
 * @author Jeevan
 */
public class DoctReqApprovalSOPChgDoctPositiveFlow extends QMSLoginDetails {

	public DoctReqApprovalSOPChgDoctPositiveFlow() {
	}
	...
	@Test
	public void toDoDoctReqApprovalSOPChgDoctPositiveFlow() throws InterruptedException {
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		methodToDoDocmtApprovalRequestChgDoctSOPPositiveFlow();

	}

	private void methodToDoDocmtApprovalRequestChgDoctSOPPositiveFlow() throws InterruptedException {
		boolean isRecordSelectedForApprovalReq = false;
		int count = 0;
		String documentNameReq = properties.getProperty("DOCUMENT_NAME_SOP_DOCT_REQUEST_CHG_DOCT_APPROVAL_FLOW");
		isRecordSelectedForApprovalReq = selectRecordDocReqApprovalSOPChgDoctPositive(documentNameReq,
	...
	private boolean selectRecordDocReqApprovalSOPChgDoctPositive(String documentNameReq,
