 ...
 * @author Jeevan
 */
public class QAApproverSOPChgDoctPositiveFlow extends QMSLoginDetails {

	public QAApproverSOPChgDoctPositiveFlow() {
	}
	...
	@Test
	public void toDoQAApproverSOPChgDoctPositiveFlow() throws InterruptedException {
		Thread.sleep(1000);
		...
		metodToDoQAApproverSOPChgDoctPositiveFlw();

	}

	private void metodToDoQAApproverSOPChgDoctPositiveFlw() throws InterruptedException {
		int count = 0;
		...
		isRecordSelectedForCFTReview = selectRecordQAApproverSOPStageSOPChgDoctPositiveFlow(documentDeptSOPReview,
	...
	private boolean selectRecordQAApproverSOPStageSOPChgDoctPositiveFlow(String documentDeptSOPReview,
