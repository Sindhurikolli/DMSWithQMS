 ...
 * @author Jeevan
 */
public class DeptReviewerChngDoc extends QMSLoginDetails {

	@Test
	public void toDeptReviewerChngDoc() throws InterruptedException, IOException, DocumentException, Exception {
		try {

			document = new Document();
			Font font = new Font(Font.FontFamily.TIMES_ROMAN);
			output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "DeptReviewerChngDoc"
			...
			writer.open();
			HeaderFooterPageEvent event = new HeaderFooterPageEvent("DeptReviewerChngDoc", "PSS-DMS-006", "Pass");
