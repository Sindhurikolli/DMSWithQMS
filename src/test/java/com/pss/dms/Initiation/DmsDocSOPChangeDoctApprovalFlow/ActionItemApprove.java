...
public class ActionItemApprove extends QMSLoginDetails {
	...
	@Test
	public void toActionItemApprove() throws InterruptedException, IOException, DocumentException, Exception {
		try {
...
//        Thread.sleep(100000);
			...
			wait1.until(ExpectedConditions.invisibilityOf(driver.findElement(
					By.cssSelector("#changeControlActionItemApprovalTable > div > div.jtable-busy-message"))));
