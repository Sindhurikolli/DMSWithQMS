...
public class DeptReviewerReject extends QMSLoginDetails {
...
//	}
	...
	private void todotoDeptReviewerReject() throws Exception {
			...
			if ((totalNoOfRecords > 1) && ((CCNumber == null) || ("".equalsIgnoreCase(CCNumber)))) {
				CCNumber = driver
						.findElement(By.xpath(
								"//*[@id=\"changeControlReviewTableContainer\"]/div/div[4]/table/tbody/tr/td[3]"))
