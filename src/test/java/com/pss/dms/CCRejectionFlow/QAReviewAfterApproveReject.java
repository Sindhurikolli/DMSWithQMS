...
public class QAReviewAfterApproveReject extends QMSLoginDetails {

	@Test
	public void toQAReviewAfterApproveReject() throws Exception {

//		try {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "QAReviewAfterApproveReject"
				+ (new Random().nextInt()) + ".pdf";
		fos = new FileOutputStream(output);
		writer = PdfWriter.getInstance(document, fos);
		writer.setStrictImageSequence(true);
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("QAReviewAfterApproveReject", "PSS-QMS-036", "Pass");
...
//	}
	...
	private void todoQAReviewAfterApproveReject() throws Exception {
...
//        String chgControlNumber = chgCtrlNoWithPlantCode + sdf + chgCtrlId;
		isRecordSelected = selectRecdQAReviewerChangeControl(CCNumber, isRecordSelected, count);
...
//            Thread.sleep(5000);
			...
			document = Utilities.getScreenShotAndAddInLogDoc(driver, document,
					"Select the Impact on quality system/processes", sno, false);
			Thread.sleep(2000);
//             sno++;
...
//			driver.findElement(By.id("reviewCompletedQaPrimaryCcReview")).click();
			...
			// uncomment when multiple approvers are there.
			...
			jse1.executeScript("arguments[0].click();", element11);
//			driver.findElement(
//					By.xpath("//*[@id=\"qaApproveUserDetailsContainer\"]/div/table/thead/tr/th[1]/div/input")).click();
//            driver.findElement(By.xpath("//*[@id=\"qaApproveUserDetailsContainer\"]/div/table/tbody/tr[3]/td[1]/input")).click();
			document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Select the required qahod user", sno,
					false);
			Thread.sleep(3000);
//            sno++;
...
//            document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Enter the comments", sno,false);
			Thread.sleep(3000);
			JavascriptExecutor jse = (JavascriptExecutor) driver;
			WebElement element = driver.findElement(By.id("approveQaPrimaryCcReview"));
			jse.executeScript("arguments[0].scrollIntoView(true);", element);
			Thread.sleep(5000);
			sno++;
			driver.findElement(By.id("commentsQaPrimaryCcReview")).sendKeys(properties.getProperty("CC_1500"));
...
//			Thread.sleep(5000);
	...
	private boolean selectRecdQAReviewerChangeControl(String CCNumber, boolean isRecordSelected, int count)
