...
public class DeptReReview extends QMSLoginDetails {

	@Test
	public void toDeptReReview() throws Exception {

//		try {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "DeptReReview" + (new Random().nextInt())
				+ ".pdf";
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("DeptReReview", "PSS-QMS-023", "Pass");
...
//	}
	...
	private void todoDeptReReview() throws Exception {
...
//			Thread.sleep(3000);
			...
			Thread.sleep(2000);
			WebElement element1 = driver.findElement(By.id("approveInHodCcReview"));
