...
//		try {
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("CustomerResponse", "PSS-QMS-007", "Pass");
				...
				if (totalNoOfRecords > 1) {
					for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
						...
						if (chgControlNumber.equalsIgnoreCase(CCNumberSequence)) {
							...
							Thread.sleep(2000);
							driver.findElement(
									By.xpath("//*[@id=\"changeControlNotifyCustomerContainer\"]/div/table/tbody/tr[ "
											+ i + " ]/td[2]"))
									.click();
