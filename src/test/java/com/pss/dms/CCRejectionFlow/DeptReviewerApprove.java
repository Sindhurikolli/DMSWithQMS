...
public class DeptReviewerApprove extends QMSLoginDetails {

	@Test
	public void toDeptReviewerApprove() throws Exception {

//		try {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "DeptReviewerApprove"
				+ (new Random().nextInt()) + ".pdf";
		fos = new FileOutputStream(output);
		writer = PdfWriter.getInstance(document, fos);
		writer.setStrictImageSequence(true);
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("DeptReviewerApprove", "PSS-QMS-021", "Pass");
...
//        sno++;
//        Thread.sleep(2000);
		WebDriverWait wait1 = new WebDriverWait(driver, 340);
...
//	}
	...
	private void todoDeptReviewerApprove() throws Exception {
...
//        System.out.println("ChangeControl Number is coming........:"+chgControlNumber);
		...
		if (isRecordSelected) {
			...
			Thread.sleep(5000);
			sno++;
			driver.findElement(By.id("uploadSuppDocDept_1")).sendKeys(properties.getProperty("Document-3"));
			...
			Thread.sleep(5000);
			WebElement element2 = driver.findElement(By.id("approveInHodCcReview"));
