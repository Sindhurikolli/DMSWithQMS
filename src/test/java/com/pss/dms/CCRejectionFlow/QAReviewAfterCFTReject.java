...
public class QAReviewAfterCFTReject extends QMSLoginDetails {

	@Test
	public void toQAReviewAfterCFTReject() throws Exception {
...
//		try {
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("QAReviewerAfterCFTReject", "PSS-QMS-026", "Pass");
...
//	}
	...
	private void todoQAReviewAfterCFTReject() throws Exception {
...
//        Thread.sleep(1000);
			...
			document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Select the CFT Department", sno, false);
			Thread.sleep(3000);
