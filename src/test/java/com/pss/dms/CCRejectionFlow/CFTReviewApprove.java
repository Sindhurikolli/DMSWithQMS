...
public class CFTReviewApprove extends QMSLoginDetails {

	@Test
	public void toCFTReviewApprove() throws Exception {

//		try {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "CFTReviewApprove" + (new Random().nextInt())
				+ ".pdf";
		fos = new FileOutputStream(output);
		writer = PdfWriter.getInstance(document, fos);
		writer.setStrictImageSequence(true);
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("CFTReviewApprove", "PSS-QMS-027", "Pass");
...
//	        System.out.println("ChangeControl Number is coming........:"+chgControlNumber);
		...
		if (isRecordSelected) {
			...
			WebElement element = driver.findElement(By.id("approveCFTButtonInCcReview"));
