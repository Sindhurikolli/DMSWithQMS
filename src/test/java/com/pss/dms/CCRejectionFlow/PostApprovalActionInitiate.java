...
//	            js.executeScript("arguments[0].click();", element11);
			document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click + to Expand Tree", sno, false);
			sno++;
...
//	            js.executeScript("arguments[0].click();", element12);
			...
			Thread.sleep(5000);
			document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on Department", sno, false);
			sno++;
...
//	            docType.selectByIndex(1);
			...
			driver.findElement(
					...
					.click();
			document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Select Existed Action Items", sno, false);
			sno++;
			Thread.sleep(5000);
//	            sno++;
