...
//            driver.findElement(By.xpath("//*[@id=\"steps-uid-0\"]/div[3]/ul/li[2]/a")).click();
			...
			driver.findElement(By.id("postRiskAssessmentDetailsInCCClosureRev")).sendKeys(properties.getProperty("CC_300"));
...
//			js.executeScript("arguments[0].click();", element6);
			driver.findElement(By.id("chkPointJustificationInCCClosureQARev1")).sendKeys(properties.getProperty("CC_2000"));
...
//			js.executeScript("arguments[0].click();", element8);
			driver.findElement(By.id("chkPointJustificationInCCClosureQARev2")).sendKeys(properties.getProperty("CC_2000"));
			document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Enter the comments", sno, false);
			Thread.sleep(3000);
			sno++;
...
//			driver.findElement(By.cssSelector("body > div.container > header > nav > ul > li.dropdown > ul > li:nth-child(3) > a")).click();
