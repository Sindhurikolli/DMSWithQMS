...
//		try {
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("QAApproverCC", "PSS-QMS-009", "Pass");
...
//        String chgControlNumber = chgCtrlNoWithPlantCode + sdf + chgCtrlId;
		...
		if (isRecordSelected) {
			...
			wait.until(ExpectedConditions.presenceOfElementLocated(By.id("commentsInFinalQaCcReview")));
			Thread.sleep(4000);
			...
			Thread.sleep(5000);
//            sno++;
//            driver.findElement(By.xpath("//*[@id=\"cQAApproveUserDetailsContainer\"]/div/table/thead/tr/th[1]/div/input")).click();
