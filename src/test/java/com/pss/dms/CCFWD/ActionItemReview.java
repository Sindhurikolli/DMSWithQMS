...
public class ActionItemReview extends QMSLoginDetails {
...
//		try {
		...
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "ActionItemReview" + (new Random().nextInt())
				+ ".pdf";
...
//        Thread.sleep(16000);
		...
		document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on Action Item Review menu", sno, false);
