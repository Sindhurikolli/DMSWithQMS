...
//		try {
		...
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "DeptReviewerCC" + (new Random().nextInt())
				+ ".pdf";
...
//	        String chgControlNumber = chgCtrlNoWithPlantCode + sdf + chgCtrlId;
		...
		if (isRecordSelected) {
			...
			wait1.until(ExpectedConditions.presenceOfElementLocated(By.id("ccAddSuppDocsDept")));
...
//							 driver.findElement(By.xpath(".//*[@id='changeControlReviewTableContainer']/div/table/tbody/tr[ " + i + "]/td[3]")).click();
...
//							Thread.sleep(1000);
					...
					String CCNumberSequence = driver
							...
							.getText();
					if (chgControlNumber.equalsIgnoreCase(CCNumberSequence)) {
						driver.findElement(By.xpath("//*[@id=\"changeControlReviewTableContainer\"]/div/table/tbody/tr/td[3]")).click();
