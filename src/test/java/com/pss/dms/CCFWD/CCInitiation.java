...
public class CCInitiation extends QMSLoginDetails {
	...
	//	try {
			...
			document.add(new Paragraph(
					sno + "." + "Enter SoftQMS url and Login Page Appears" + Utilities.prepareSSNumber(sno),
					font));
			document.add(im);
			...
			sno++;
			document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Enter the username, password, Select Change Control Module and click on login button", sno, false);
//				sno++;
...
//        Thread.sleep(5000);
		...
		Thread.sleep(5000);
		sno++;
		if(driver.findElement(By.id("productNameInAddProd")).isDisplayed())
		{
		...
		wait1.until(ExpectedConditions.or(
			    ExpectedConditions.presenceOfElementLocated(By.id("locTreeForAddDocuments_2_span")),
			    ExpectedConditions.presenceOfElementLocated(By.id("docTitleInCCDocDlg"))
			));
		
		if(driver.findElement(By.id("locTreeForAddDocuments_2_span")).isDisplayed())
		{
...
//        Thread.sleep(5000);
		...
		sno++;
		wait1.until(ExpectedConditions.or(
			    ExpectedConditions.presenceOfElementLocated(By.id("locTreeForAddEquipments_2_span")),
			    ExpectedConditions.presenceOfElementLocated(By.id("eqptNameInCCEqptDlg"))
			));
		if(driver.findElement(By.id("locTreeForAddEquipments_2_span")).isDisplayed())
		{
		...
		sno++;
		wait1.until(ExpectedConditions.or(
			    ExpectedConditions.presenceOfElementLocated(By.id("locTreeForAddInstruments_2_span")),
			    ExpectedConditions.presenceOfElementLocated(By.id("instrNoInCCInstrumentDlg"))
			));
		if(driver.findElement(By.id("locTreeForAddInstruments_2_span")).isDisplayed())
		{
