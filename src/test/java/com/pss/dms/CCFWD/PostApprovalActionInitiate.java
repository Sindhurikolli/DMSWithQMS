...
//		try {
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("PostApprovalActionInitiate", "PSS-QMS-010", "Pass");
...
//        Thread.sleep(16000);
		...
		document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on Initiate at Post Approval Actions menu", sno,false);
		sno++;
...
//
			...
			sno++;
			Thread.sleep(5000);
			driver.findElement(By.xpath("//*[@id=\"docDetailsTableNewInCcRev\"]/div/div[3]/div[2]/span[1]/span[2]"))
					.click();
			document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on New document button", sno,
					false);
			sno++;
			Thread.sleep(5000);
			
			driver.findElement(By.id("docNameInAddNewDocDlg"))
...
//	            docType.selectByIndex(1);
			...
			Thread.sleep(2000);
			document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Select Document Type", sno, false);
			sno++;
...
//			driver.findElement(By.id("docTreeInCCReview_3_span")).click();
			...
			Thread.sleep(5000);			
			driver.findElement(
					By.xpath("//*[@id=\"existedActionItemDetailsInNewDocSelDialog\"]/div/table/tbody/tr/td[2]"))
					.click();
			document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Select Existed Action Item", sno, false);
			sno++;
			Thread.sleep(5000);
//	            sno++;
...
//	            Thread.sleep(5000);
//	            sno++;
//                Select ActionItemDropDown = new Select(driver.findElement(By.id("actItemsInCcRevNewDocDlg")));
	...
	private boolean selectRecdPostApprovalActionInitiate(String CCNumber, boolean isRecordSelected, int count)
		...
		if (perPageNoOfRecordsPresent > 0 && count == 0) {
			if ((totalNoOfRecords > 1) && ((CCNumber == null) || ("".equalsIgnoreCase(CCNumber)))) {
				CCNumber = driver
						.findElement(By.xpath("//*[@id=\"ccPostApprovalInitiateTable\"]/div/table/tbody/tr[1]/td[6]"))
...
//									".//*[@id='ccPostApprovalInitiateTable']/div/table/tbody/tr[ " + i + "]/td[6]"));
							 driver.findElement(By.xpath(".//*[@id='ccPostApprovalInitiateTable']/div/table/tbody/tr[ " + i + "]/td[6]")).click();
