...
public class CCclosureApprove extends QMSLoginDetails {
...
//		try {
		...
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "CCClosureApprove" + (new Random().nextInt())
				+ ".pdf";
...
//       Thread.sleep(16000);
		...
		document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on closure Approve sub menu", sno,false);
		...
		wait1.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector(
				"#changeControlCloseApproveTableContainer > div > div.jtable-busy-message[style='display: none;']")));
		Thread.sleep(2000);
