...
public class RegReviewerCC extends QMSLoginDetails {
	...
	@Test
	public void toRegReviewerCC() throws InterruptedException, IOException, DocumentException, Exception {
//		try {
		...
		sno++;
		Thread.sleep(5000);
		wait1.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("a[href='ccRegulatoryReviewPage.do']")));
...
//        System.out.println("CC Number is coming........:"+CCNumber);
		...
		if (isRecordSelected) {
			...
			wait1.until(ExpectedConditions.presenceOfElementLocated(By.id("commentsInRegulatoryCcReview")));
...
//            }
			...
			document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Select Accept Radio Button and Click On Submit button", sno, false);
			Thread.sleep(5000);
			sno++;
...
//							 driver.findElement(By.xpath(".//*[@id='changeControlRegulatoryReviewTableContainer']/div/table/tbody/tr[" + i + "]/td[52]/button")).click();
					...
					String CCNumberSequence = driver.findElement(By.xpath(".//*[@id='changeControlRegulatoryReviewTableContainer']/div/table/tbody/tr/td[3]")).getText();
					if (chgControlNumber.equalsIgnoreCase(CCNumberSequence)) {
						
						driver.findElement(By.xpath(".//*[@id='changeControlRegulatoryReviewTableContainer']/div/table/tbody/tr/td[52]/button")).click();
						isRecordSelected = true;
						break;
					}
				}
