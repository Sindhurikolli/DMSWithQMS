...
public class PostApprovalActionInitiateTerminateDocument extends QMSLoginDetails {
	@Test
...
//
			...
			document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on Add button", sno, false);
			Thread.sleep(5000);
			driver.findElement(By.xpath("//*[@id=\"docDetailsTableNewInCcRev\"]/div/div[3]/div[2]/span[3]/span[2]"))
					.click();
			document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on Terminate document button",
					sno, false);
			Thread.sleep(5000);
			sno++;
			wait.until(ExpectedConditions.presenceOfElementLocated(By.id("locTreeForAddDocuments_2_span")));
...
//			  String doctype = (String) properties.getProperty("DocumentType"); Map
//			  changeDocDetails = selectRecdForDocType(doctype, isRecordSelectedForChngDoc,
//			  count1); System.out.println(changeDocDetails.get("name"));
//			  System.out.println(changeDocDetails.get("no")); PropertiesConfiguration
//			  properties = new PropertiesConfiguration(
//			  "src/test/java/com/pss/dms/properties/DMSProperties.properties");
//			  properties.setProperty("DOCUMENT_NAME_SOP_DOCT_REQUEST",
//			  changeDocDetails.get("name"));
//			  properties.setProperty("DOCT_NO_INITIATE_NEW_DOCT_SOP",
//			  changeDocDetails.get("no")); properties.save();
			 
			String ChngDocRec = (String) properties.getProperty("DOCUMENT_NAME_SOP_DOCT_REQUEST");
			Thread.sleep(4000);
			isRecordSelectedForChngDoc = selectRecdForChngDoc(ChngDocRec, isRecordSelectedForChngDoc, count1);
			Thread.sleep(4000);
...
//	            js.executeScript("arguments[0].click();", element9);
	...
	private Map selectRecdForDocType(String doctype, boolean isRecordSelectedForChngDoc, int count1)
			throws InterruptedException {
		...
		if (perPageNoOfRecordsPresent > 0 && count1 == 0) {
			if ((totalNoOfRecords > 1) && ((doctype == null) || ("".equalsIgnoreCase(doctype)))) {
				doctype = driver
						.findElement(By
								.xpath("//*[@id=\"documentsWidowDetialsTableContainer\"]/div/table/tbody/tr[1]/td[6]"))
						.getText();// documentType
			} else if ((doctype == null) || ("".equalsIgnoreCase(doctype))) {
				doctype = driver
						.findElement(By
								.xpath("//*[@id=\"documentsWidowDetialsTableContainer\"]/div/table/tbody/tr[1]/td[6]"))
						.getText();// documentType
					...
					for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
						String CCNumberSequence = driver.findElement(
								By.xpath("//*[@id=\"documentsWidowDetialsTableContainer\"]/div/table/tbody/tr[ " + i
										+ " ]/td[6]"))
								.getText();// documentTypeName
						if (doctype.equalsIgnoreCase(CCNumberSequence)) {
//	                        	docDetails[0] =  driver.findElement(By.xpath("//*[@id=\"documentsWidowDetialsTableContainer\"]/div/table/tbody/tr[ " + i + " ]/td[3]")).getText();
//	                        	docDetails[1] =  driver.findElement(By.xpath("//*[@id=\"documentsWidowDetialsTableContainer\"]/div/table/tbody/tr[ " + i + " ]/td[4]")).getText();
							map.put("name",
									driver.findElement(By.xpath(
											"//*[@id=\"documentsWidowDetialsTableContainer\"]/div/table/tbody/tr[ " + i
													+ " ]/td[3]"))
											.getText());
							map.put("no",
									driver.findElement(By.xpath(
					...
					String CCNumberSequence = driver
							.findElement(By.xpath(
									"//*[@id=\"documentsWidowDetialsTableContainer\"]/div/table/tbody/tr[1]/td[6]"))
							.getText();
					if (doctype.equalsIgnoreCase(CCNumberSequence)) {
//	                    	docDetails[0] = driver.findElement(By.xpath("//*[@id=\"documentsWidowDetialsTableContainer\"]/div/table/tbody/tr[1]/td[3]")).getText();
//	                    	docDetails[1] =  driver.findElement(By.xpath("//*[@id=\"documentsWidowDetialsTableContainer\"]/div/table/tbody/tr[1]/td[4]")).getText();
						map.put("name",
								driver.findElement(By.xpath(
										"//*[@id=\"documentsWidowDetialsTableContainer\"]/div/table/tbody/tr[1]/td[3]"))
										.getText());
						map.put("no",
								driver.findElement(By.xpath(
										"//*[@id=\"documentsWidowDetialsTableContainer\"]/div/table/tbody/tr[1]/td[4]"))
										.getText());
						isRecordSelectedForChngDoc = true;
						break;
					}
