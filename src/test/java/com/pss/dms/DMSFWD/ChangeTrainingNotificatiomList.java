...
public class ChangeTrainingNotificatiomList extends QMSLoginDetails {

	@Test
	public void toChangeTrainingNotificatiomList()
			throws InterruptedException, IOException, DocumentException, Exception {
//		try {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "ChangeTrainingNotificatiomList"
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("ChangeTrainingNotificatiomList", "PSS-DMS-010",
				"Pass");
...
//        driver.findElement(By.cssSelector("a[href='dmsTrngNotfListPage.do']")).click();
		...
		todoChangeTrainingNotificatiomList();
		document.close();
		writer.close();
...
//    }
	...
	private void todoChangeTrainingNotificatiomList() throws Exception {
		sno++;
...
//            document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click on Is training required checkbox", sno,false);
//            sno++;
//            Thread.sleep(4000);
//            boolean isRecordSelectedSingleApprovalDoctReqSOP = false;
//            int count = 0;
//            driver.findElement(By.cssSelector("#hiddenIdForAppOrCmnts > div.row.form-group.col-sm-12 > button")).click();
		...
		if (perPageNoOfRecordsPresent > 0 && count1 == 0) {
			if ((totalNoOfRecords > 1)
				...
				documentNameInNotification = driver
						.findElement(By.xpath("//*[@id=\"dmsTrngNotfListTable\"]/div/div[4]/table/tbody/tr[1]/td[]"))
