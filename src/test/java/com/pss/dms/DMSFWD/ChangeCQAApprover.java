...
public class ChangeCQAApprover extends QMSLoginDetails {

	@Test
	public void toChangeCQAApprover() throws InterruptedException, IOException, DocumentException, Exception {
//		try {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "ChangeCQAApprover" + (new Random().nextInt())
				+ ".pdf";
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("ChangeCQAApprover", "PSS-DMS-009", "Pass");
...
//    }
	...
	private void todoChangeCQAApprover() throws Exception {
		sno++;
		int count = 0;
