...
public class DMSCFTReviewer extends QMSLoginDetails {
	...
	@Test
	public void toDMSCFTReviewer() throws InterruptedException, IOException, DocumentException, Exception {
//		try {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "CFTReviewerSOP" + (new Random().nextInt())
				+ ".pdf";
...
//    }
	...
	private void todoDMSCFTReviewer() throws Exception {
		sno++;
		int count = 0;
