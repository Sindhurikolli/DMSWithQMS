...
public class TerminateQAApprover extends QMSLoginDetails {
	@Test
	public void toTerminateQAApprover() throws InterruptedException, IOException, DocumentException, Exception {
//		try {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "TerminateQAApprover"
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("TerminateQAApprover", "PSS-DMS-006", "Pass");
...
//    }
	...
	private void todoTerminateQAApprover() throws Exception {
		sno++;
		int count = 0;
