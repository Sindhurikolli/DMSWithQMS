...
public class DMSTrainingNotificatiomList extends QMSLoginDetails {

	@Test
	public void toDMSTrainingNotificationList() throws InterruptedException, IOException, DocumentException, Exception {
//		try {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "TrainingNotificationList"
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("TrainingNotificationList", "PSS-DMS-010", "Pass");
