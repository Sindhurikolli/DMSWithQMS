...
public class DMSQAReviewer extends QMSLoginDetails {
	...
	@Test
	public void toDMSQAReviewer() throws InterruptedException, IOException, DocumentException, Exception {
//		try {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "QAReviewerSOP" + (new Random().nextInt())
				+ ".pdf";
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("QAReviewerSOP", "PSS-DMS-007", "Pass");
...
//    }
	...
	private void todoDMSQAReviewer() throws Exception {
		sno++;
		int count = 0;
