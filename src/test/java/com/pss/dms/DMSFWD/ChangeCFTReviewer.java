...
public class ChangeCFTReviewer extends QMSLoginDetails {

	@Test
	public void toChangeCFTReviewer() throws InterruptedException, IOException, DocumentException, Exception {
//		try {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "ChangeCFTReviewer" + (new Random().nextInt())
				+ ".pdf";
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("ChangeCFTReviewer", "PSS-DMS-008", "Pass");
...
//    }
	...
	private void todoChangeCFTReviewer() throws Exception {
		sno++;
		int count = 0;
		...
		isRecordSelectedForCFTReview = selectRecordCFTReviewStage(documentDeptSOPReview, isRecordSelectedForCFTReview,
				count);
		Thread.sleep(1000);
		sno++;
...
//                        		document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Click On LogOut ", sno,true);
	...
	private boolean selectRecordCFTReviewStage(String documentDeptSOPReview, boolean isRecordSelectedForCFTReview,
