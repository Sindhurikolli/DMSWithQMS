...
public class ChangeDocumentRequestApproval extends QMSLoginDetails {

	@Test
	public void ChangeDocumentRequestApprovalMethod()
			throws InterruptedException, IOException, DocumentException, Exception {
//		try {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "ChangeDocumentRequestApproval"
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("ChangeDocumentRequestApproval", "PSS-DMS-004", "Pass");
...
//	}
	...
	private void toChangeDocumentRequestApprovalMethod() throws Exception {
		...
		if (isRecordSelectedForApprovalReq) {
			driver.findElement(By.id("changeDocRequestAppComments"))
					.sendKeys(properties.getProperty("COMMENTS_NEW_DOCT_REQ_APPROVAL"));
			document = Utilities.getScreenShotAndAddInLogDoc(driver, document, "Enter the comments", sno, false);
			Thread.sleep(1000);
			sno++;
			driver.findElement(By.id("approveBtnInchangeDocRequestApp")).click();
