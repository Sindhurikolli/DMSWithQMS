...
public class DMSNoTrainingNotificationList extends QMSLoginDetails {

	@Test
	public void toDMSDocumentTrainingNotificationList()
			throws InterruptedException, IOException, DocumentException, Exception {
//		try {

		document = new Document();
		Font font = new Font(Font.FontFamily.TIMES_ROMAN);
		output = System.getProperty("user.dir") + "\\" + "/TestReport/" + "DMSNoTrainingNotificationList"
		...
		writer.open();
		HeaderFooterPageEvent event = new HeaderFooterPageEvent("DMSNoTrainingNotificationList", "PSS-DMS-010", "Pass");
...
//        driver.findElement(By.cssSelector("a[href='dmsTrngNotfListPage.do']")).click();
		...
		todoDMSNoTrainingNotificationList();
		document.close();
		writer.close();
...
//    }
	...
	private void todoDMSNoTrainingNotificationList() throws Exception {
		sno++;
