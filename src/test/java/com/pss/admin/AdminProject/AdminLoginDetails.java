...
public class AdminLoginDetails {
	...
	public void setUp() throws Exception {
		...
		if (propertiesFilePath != null) {
			...
			propertyFilePathName = "src\\test\\java\\com\\pss\\dms\\properties\\adminproperties.properties";
		}
		...
		try {
			...
			e.printStackTrace();
			throw new RuntimeException("adminproperties.properties not found at " + propertyFilePath);
		}
