...
public class OrganizationNodeApproval extends AdminLoginDetails {
	...
	private void toApproveOrganizationNodes() throws InterruptedException {
		...
		wait.until(ExpectedConditions.presenceOfElementLocated(
				By.cssSelector("#approvalOrganizationTable > div > div.jtable-busy-message[style='display: none;']")));
	...
	private boolean selectingTheNode(String NodeName, boolean isRecordSelectedForNode, int count5)
...
//	        }
		if (perPageNoOfRecordsPresent > 0 && count5 == 0) {
			if (((NodeName == null) || ("".equalsIgnoreCase(NodeName)))) {
				NodeName = driver
						.findElement(By.xpath("//*[@id=\"approvalOrganizationTable\"]/div/table/tbody/tr[1]/td[3]"))
						.getText();// documentType
			} else if ((NodeName == null) || ("".equalsIgnoreCase(NodeName))) {
				NodeName = driver
						.findElement(By.xpath("//*[@id=\"approvalOrganizationTable\"]/div/table/tbody/tr/td[3]"))
						.getText();// documentType
...
//	            	System.out.println("While Loop........");
				if (perPageNoOfRecordsPresent > 1) {
					for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
						String AppNodeName = driver
								.findElement(By.xpath(
										"//*[@id=\"approvalOrganizationTable\"]/div/table/tbody/tr[ " + i + " ]/td[3]"))
...
//	                        System.out.println("NodeName: "+NodeName);
					...
					if (NodeName.equalsIgnoreCase(AppNodeName)) {
						driver.findElement(
								By.xpath("//*[@id=\"approvalOrganizationTable\"]/div/table/tbody/tr[1]/td[3]")).click();
						isRecordSelectedForNode = true;
				...
				if ((!isRecordSelectedForNode) && (noOfRecordsChecked < totalNoOfRecords)) {
					driver.findElement(By.cssSelector(
							"#approvalOrganizationTable > div > div.jtable-bottom-panel > div.jtable-left-area > span.jtable-page-list > span.jtable-page-number-next"))
