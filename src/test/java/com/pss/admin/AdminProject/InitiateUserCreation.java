...
//        driver.findElement(By.id("tree-container_4_span")).click();
		...
		Thread.sleep(2000);
		driver.findElement(By.id("qualificationInCreateUser"))
				.sendKeys(properties.getProperty("qualification_InCreateUser"));
		Thread.sleep(2000);
		...
		Thread.sleep(1000);
		driver.findElement(By.xpath("/html/body/div[1]/header/nav/ul/li[2]/ul/li[3]/a")).click();
	}

	private boolean selectingTheUser(String UserFullName, boolean isRecordSelectedForUser, int count5)
		...
		if (perPageNoOfRecordsPresent > 0 && count5 == 0) {
			if (((UserFullName == null) || ("".equalsIgnoreCase(UserFullName)))) {
				...
				UserFullName = driver.findElement(By.xpath("//*[@id=\"usersTableContainer\"]/div/table/tbody/tr/td[2]"))
						.getText();// documentType
...
//	            	System.out.println("While Loop........");
				if (perPageNoOfRecordsPresent > 1) {
					...
					String AppUserFullName = driver
							...
							.getText();
					if (UserFullName.equalsIgnoreCase(AppUserFullName)) {
						driver.findElement(By.xpath("//*[@id=\"usersTableContainer\"]/div/table/tbody/tr[1]/td[1]"))
								.click();
						isRecordSelectedForUser = true;
