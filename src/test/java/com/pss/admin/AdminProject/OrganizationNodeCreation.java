package com.pss.admin.AdminProject;
...
public class OrganizationNodeCreation extends AdminLoginDetails {
	...
	private void toCreateOrganizationNodes() throws InterruptedException {
		...
		wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector(
				"#usersTableContainerInUserMenuBaseSel > div > div.jtable-busy-message[style='display: none;']")));
		...
		if (isRecordSelectedForAdmin) {
			...
			Thread.sleep(1000);
			driver.findElement(
					By.cssSelector("body > div.container > header > nav > ul > li.dropdown > ul > li:nth-child(2) > a"))
					.click();
		} else {
	...
	private boolean selectingTheApprover(String AdminECode, boolean isRecordSelectedForAdmin, int count5)
		...
		if (perPageNoOfRecordsPresent > 0) {
			String a = driver
					.findElement(By.xpath("//*[@id=\"usersTableContainerInUserMenuBaseSel\"]/div/div[4]/div[2]/span"))
		...
		if (perPageNoOfRecordsPresent > 0 && count5 == 0) {
			if (((AdminECode == null) || ("".equalsIgnoreCase(AdminECode)))) {
				AdminECode = driver
						.findElement(By
								.xpath("//*[@id=\"usersTableContainerInUserMenuBaseSel\"]/div/table/tbody/tr[1]/td[4]"))
						.getText();// documentType
			} else if ((AdminECode == null) || ("".equalsIgnoreCase(AdminECode))) {
				AdminECode = driver
						.findElement(
								By.xpath("//*[@id=\"usersTableContainerInUserMenuBaseSel\"]/div/table/tbody/tr/td[4]"))
						.getText();// documentType
...
//	            	System.out.println("While Loop........");
				if (perPageNoOfRecordsPresent > 1) {
					for (int i = 1; i <= perPageNoOfRecordsPresent; i++) {
						String AppAdminECode = driver.findElement(
								By.xpath("//*[@id=\"usersTableContainerInUserMenuBaseSel\"]/div/table/tbody/tr[ " + i
										+ " ]/td[4]"))
								.getText();// documentTypeName
//	                        System.out.println("AdminECode: "+AdminECode);
						if (AdminECode.equalsIgnoreCase(AppAdminECode)) {
							driver.findElement(
									By.xpath("//*[@id=\"usersTableContainerInUserMenuBaseSel\"]/div/table/tbody/tr[ "
											+ i + " ]/td[4]"))
									.click();
					...
					String AppAdminECode = driver
							.findElement(By.xpath(
									"//*[@id=\"usersTableContainerInUserMenuBaseSel\"]/div/table/tbody/tr[1]/td[4]"))
							.getText();
					if (AdminECode.equalsIgnoreCase(AppAdminECode)) {
				...
				if ((!isRecordSelectedForAdmin) && (noOfRecordsChecked < totalNoOfRecords)) {
					driver.findElement(By.cssSelector(
							"#usersTableContainerInUserMenuBaseSel > div > div.jtable-bottom-panel > div.jtable-left-area > span.jtable-page-list > span.jtable-page-number-next"))
							.click();// next page in Document approve list
					Thread.sleep(3000);
					table = driver.findElement(By.id("usersTableContainerInUserMenuBaseSel"));// Document Tree approve
																								// table
