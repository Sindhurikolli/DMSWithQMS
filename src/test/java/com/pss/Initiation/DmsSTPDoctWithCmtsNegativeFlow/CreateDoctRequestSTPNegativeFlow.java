 ...
 * @author Jeevan
 */
public class CreateDoctRequestSTPNegativeFlow extends QMSLoginDetails {

	public CreateDoctRequestSTPNegativeFlow() {
	}
	...
	@Test
	public void toDoCreateDoctRequestSTPNegativeFlow() throws InterruptedException {
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		metodToCreateDoctRequestSTPRejectFlow();

	}

	private void metodToCreateDoctRequestSTPRejectFlow() throws InterruptedException {
		driver.findElement(By.id("documentNameInNewDocRequestPage"))
				.sendKeys(properties.getProperty("DOCUMENT_NAME_STP_DOCT_REQUEST_REJECT_FLOW"));
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		methodToSelectCreateDoctReqSTPRejectFlow();
	}

	private void methodToSelectCreateDoctReqSTPRejectFlow() throws InterruptedException {
		driver.findElement(By.id("selectRepToInCreateUser")).click();
		Thread.sleep(1000);
		boolean isRecordSelectedSingleApprovalDoctReqSTPRejectFlow = false;
		...
		isRecordSelectedSingleApprovalDoctReqSTPRejectFlow = Helper.selectSingleApprovalRecord(driver,
				userSingleApprovalName, isRecordSelectedSingleApprovalDoctReqSTPRejectFlow, count);
		Thread.sleep(1000);
		if (isRecordSelectedSingleApprovalDoctReqSTPRejectFlow) {
