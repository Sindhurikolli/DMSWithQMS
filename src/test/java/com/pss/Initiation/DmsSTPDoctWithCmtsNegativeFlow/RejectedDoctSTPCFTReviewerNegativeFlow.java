 ...
 * @author Jeevan
 */
public class RejectedDoctSTPCFTReviewerNegativeFlow extends QMSLoginDetails {

	public RejectedDoctSTPCFTReviewerNegativeFlow() {
	}
	...
	@Test
	public void toDoRejectedDoctSTPCFTReviewerNegativeFlow() throws InterruptedException {
		Thread.sleep(1000);
		...
		metodToDoRejectedDocCFTReviewerSTPRejectFlow();

	}

	private void metodToDoRejectedDocCFTReviewerSTPRejectFlow() throws InterruptedException {
		int count = 0;
		...
		isRecordSelectedForCFTReview = selectRejectedDocCFTSTPRejectFlow(documentDeptSOPReview,
	...
	private boolean selectRejectedDocCFTSTPRejectFlow(String documentDeptSOPReview,
