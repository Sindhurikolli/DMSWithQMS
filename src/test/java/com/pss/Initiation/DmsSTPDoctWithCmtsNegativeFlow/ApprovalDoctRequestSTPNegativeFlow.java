 ...
 * @author Jeevan
 */
public class ApprovalDoctRequestSTPNegativeFlow extends QMSLoginDetails {

	public ApprovalDoctRequestSTPNegativeFlow() {
	}
	...
	@Test
	public void toDoApprovalDoctRequestSTPNegativeFlow() throws InterruptedException {
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		methodToDoDocmtApprovalRequestSTPNegativeFlow();

	}

	private void methodToDoDocmtApprovalRequestSTPNegativeFlow() throws InterruptedException {
		boolean isRecordSelectedForApprovalReq = false;
		int count = 0;
		String documentNameReq = properties.getProperty("DOCUMENT_NAME_STP_DOCT_REQUEST_REJECT_FLOW");
		isRecordSelectedForApprovalReq = selectRecordDocReqApprovalSTPNegativeFlow(documentNameReq,
	...
	private boolean selectRecordDocReqApprovalSTPNegativeFlow(String documentNameReq,
