 ...
 * @author Jeevan
 */
public class TrngNotificationSTPDoctRejectFlow extends QMSLoginDetails {

	public TrngNotificationSTPDoctRejectFlow() {
	}
	...
	@Test
	public void toDoTrngNotificationSTPDoctRejectFlow() throws InterruptedException {
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		methodToSelectRecordTrainingNotifiyListSTPRejectFlow();
		Thread.sleep(1000);

	}

	private void methodToSelectRecordTrainingNotifiyListSTPRejectFlow() throws InterruptedException {
		boolean isRecordSelectedTrainingNotification = false;
		int count = 0;
		String documentNameInNotification = properties.getProperty("DOCUMENT_NAME_STP_DOCT_REQUEST_REJECT_FLOW");
		isRecordSelectedTrainingNotification = selectRecordTrngNotificationSTPRejectFlow(documentNameInNotification,
		...
		if (isRecordSelectedTrainingNotification) {
			...
			Thread.sleep(1000);
			methodToSelectRecordSingleApprovalSTPTrngNotifiyRejectFlow();
		} else {
			System.out.println("Record is not Selected");
		}
	}

	private boolean selectRecordTrngNotificationSTPRejectFlow(String documentNameInNotification,
	...
	private void methodToSelectRecordSingleApprovalSTPTrngNotifiyRejectFlow() throws InterruptedException {
