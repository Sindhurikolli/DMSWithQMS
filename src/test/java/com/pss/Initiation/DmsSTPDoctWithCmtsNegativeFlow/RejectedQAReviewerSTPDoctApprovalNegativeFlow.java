 ...
 * @author Jeevan
 */
public class RejectedQAReviewerSTPDoctApprovalNegativeFlow extends QMSLoginDetails {

	public RejectedQAReviewerSTPDoctApprovalNegativeFlow() {
	}
	...
	@Test
	public void toDoRejectedQAReviewerSTPDoctApprovalNegativeFlow() throws InterruptedException {
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		metodToDoRejectedDocQAReviewerSTPRejectFlow();

	}

	private void metodToDoRejectedDocQAReviewerSTPRejectFlow() throws InterruptedException {
		int count = 0;
		...
		isRecordSelectedForQAReview = selectRejectedDocQAReviewerSTPRejectFlow(documentDeptSOPReview,
	...
	private boolean selectRejectedDocQAReviewerSTPRejectFlow(String documentDeptSOPReview,
